...
switch($_GET[act]){
  // Tampil Office
  default:
    $edit=mysql_query("SELECT * FROM tbl_msembassy WHERE CountryID = '$_GET[code]'");
    ...
    echo "<h2>$r[Country]</h2>    
          ...
          <tr><td>Visa Time Frame</td><td><input type='text' name='visatimeframe' size='1' value='$r[VisaTimeFrame]' required> DAYS</td></tr>
          </table>     
...
case "save":                           
  $Description="Update Visa Time Frame ($_POST[id])"; 
  mysql_query("UPDATE tbl_msembassy SET VisaTimeFrame = '$_POST[visatimeframe]'
