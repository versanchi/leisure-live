...
switch($_GET[act]) {
    ...
    default:
        ...
        //cek banyak data
        $datavar = mysql_query("SELECT * FROM tour_detail where Category = 'VARIABLE' and IDProduct = '$r[IDProduct]'");
        ...
        while ($s = mssql_fetch_array($tampil)) {
            if ($s[Currency] == $var1[QuotationCurr]) {
        ...
        echo "</select><input type='hidden' name='sellingoperator1' size='3' value='$var1[SellingOperator]' > x
                     ...
                     </td><td><input type=text name='quoadult1' size='12' value='$var1[QuoAdult]' style='text-align:right' onkeyup='isNumber(this);UpdateSellA(1)' ";
        if ($var1[Description] == '') {
            echo "readonly";
        }
        echo "></td>
        ...
        $tampil = mssql_query("SELECT Currency FROM AgingKursDetails Group by Currency ORDER BY Currency ASC");
        while ($s = mssql_fetch_array($tampil)) {
            if ($s[Currency] == $var2[QuotationCurr]) {
                echo "<option value='$s[Currency]' selected>$s[Currency]</option>";
            } else {
                echo "<option value='$s[Currency]' >$s[Currency]</option>";
            }
        ...
        echo "</select><input type='hidden' name='sellingoperator2' size='3' value='$var2[SellingOperator]' > x
                     ...
                     </td><td><input type=text name='quoadult2' size='12' value='$var2[QuoAdult]' style='text-align:right' onkeyup='isNumber(this);UpdateSellA(2)' ";
        if ($var2[Description] == '') {
            echo "readonly";
        }
        echo "></td>
        ...
        $tampil = mssql_query("SELECT Currency FROM AgingKursDetails Group by Currency ORDER BY Currency ASC");
        while ($s = mssql_fetch_array($tampil)) {
            if ($s[Currency] == $var3[QuotationCurr]) {
                echo "<option value='$s[Currency]' selected>$s[Currency]</option>";
            } else {
                echo "<option value='$s[Currency]' >$s[Currency]</option>";
            }
        ...
        echo "</select><input type='hidden' name='sellingoperator3' size='3' value='$var3[SellingOperator]' > x
                     ...
                     </td><td><input type=text name='quoadult3' size='12' value='$var3[QuoAdult]' style='text-align:right' onkeyup='isNumber(this);UpdateSellA(3)' ";
        if ($var3[Description] == '') {
            echo "readonly";
        }
        echo "></td>
        ...
        $tampil = mssql_query("SELECT Currency FROM AgingKursDetails Group by Currency ORDER BY Currency ASC");
        while ($s = mssql_fetch_array($tampil)) {
            if ($s[Currency] == $var4[QuotationCurr]) {
                echo "<option value='$s[Currency]' selected>$s[Currency]</option>";
            } else {
                echo "<option value='$s[Currency]' >$s[Currency]</option>";
            }
        ...
        echo "</select><input type='hidden' name='sellingoperator4' size='3' value='$var4[SellingOperator]' > x
                     ...
                     </td><td><input type=text name='quoadult4' size='12' value='$var4[QuoAdult]' style='text-align:right' onkeyup='isNumber(this);UpdateSellA(4)' ";
        if ($var4[Description] == '') {
            echo "readonly";
        }
        echo "></td>
        ...
        $tampil = mssql_query("SELECT Currency FROM AgingKursDetails Group by Currency ORDER BY Currency ASC");
        while ($s = mssql_fetch_array($tampil)) {
            if ($s[Currency] == $var5[QuotationCurr]) {
                echo "<option value='$s[Currency]' selected>$s[Currency]</option>";
            } else {
                echo "<option value='$s[Currency]' >$s[Currency]</option>";
            }
        ...
        echo "</select><input type='hidden' name='sellingoperator5' size='3' value='$var5[SellingOperator]' > x
                     ...
                     </td><td><input type=text name='quoadult5' size='12' value='$var5[QuoAdult]' style='text-align:right' onkeyup='isNumber(this);UpdateSellA(5)' ";
        if ($var5[Description] == '') {
            echo "readonly";
        }
        echo "></td>
        ...
        $tampil = mssql_query("SELECT Currency FROM AgingKursDetails Group by Currency ORDER BY Currency ASC");
        while ($s = mssql_fetch_array($tampil)) {
            if ($s[Currency] == $var6[QuotationCurr]) {
                echo "<option value='$s[Currency]' selected>$s[Currency]</option>";
            } else {
                echo "<option value='$s[Currency]' >$s[Currency]</option>";
            }
        ...
        echo "</select><input type='hidden' name='sellingoperator6' size='3' value='$var6[SellingOperator]' > x
                     ...
                     </td><td><input type=text name='quoadult6' size='12' value='$var6[QuoAdult]' style='text-align:right' onkeyup='isNumber(this);UpdateSellA(6)' ";
        if ($var6[Description] == '') {
            echo "readonly";
        }
        echo "></td>
        ...
        $tampil = mssql_query("SELECT Currency FROM AgingKursDetails Group by Currency ORDER BY Currency ASC");
        while ($s = mssql_fetch_array($tampil)) {
            if ($s[Currency] == $var7[QuotationCurr]) {
                echo "<option value='$s[Currency]' selected>$s[Currency]</option>";
            } else {
                echo "<option value='$s[Currency]' >$s[Currency]</option>";
            }
        ...
        echo "</select><input type='hidden' name='sellingoperator7' size='3' value='$var7[SellingOperator]' > x
                     ...
                     </td><td><input type=text name='quoadult7' size='12' value='$var7[QuoAdult]' style='text-align:right' onkeyup='isNumber(this);UpdateSellA(7)' ";
        if ($var7[Description] == '') {
            echo "readonly";
        }
        echo "></td>
        ...
        $tampil = mssql_query("SELECT Currency FROM AgingKursDetails Group by Currency ORDER BY Currency ASC");
        while ($s = mssql_fetch_array($tampil)) {
            if ($s[Currency] == $var8[QuotationCurr]) {
                echo "<option value='$s[Currency]' selected>$s[Currency]</option>";
            } else {
                echo "<option value='$s[Currency]' >$s[Currency]</option>";
            }
        ...
        echo "</select><input type='hidden' name='sellingoperator8' size='3' value='$var8[SellingOperator]' > x
                     ...
                     </td><td><input type=text name='quoadult8' size='12' value='$var8[QuoAdult]' style='text-align:right' onkeyup='isNumber(this);UpdateSellA(8)' ";
        if ($var8[Description] == '') {
            echo "readonly";
        }
        echo "></td>
        ...
        $tampil = mssql_query("SELECT Currency FROM AgingKursDetails Group by Currency ORDER BY Currency ASC");
        while ($s = mssql_fetch_array($tampil)) {
            if ($s[Currency] == $var9[QuotationCurr]) {
                echo "<option value='$s[Currency]' selected>$s[Currency]</option>";
            } else {
                echo "<option value='$s[Currency]' >$s[Currency]</option>";
            }
        ...
        echo "</select><input type='hidden' name='sellingoperator9' size='3' value='$var9[SellingOperator]' > x
                     ...
                     </td><td><input type=text name='quoadult9' size='12' value='$var9[QuoAdult]' style='text-align:right' onkeyup='isNumber(this);UpdateSellA(9)' ";
        if ($var9[Description] == '') {
            echo "readonly";
        }
        echo "></td>
        ...
        $tampil = mssql_query("SELECT Currency FROM AgingKursDetails Group by Currency ORDER BY Currency ASC");
        while ($s = mssql_fetch_array($tampil)) {
            if ($s[Currency] == $var10[QuotationCurr]) {
                echo "<option value='$s[Currency]' selected>$s[Currency]</option>";
            } else {
                echo "<option value='$s[Currency]' >$s[Currency]</option>";
            }
        ...
        echo "</select><input type='hidden' name='sellingoperator10' size='3' value='$var10[SellingOperator]' > x
                     ...
                     </td><td><input type=text name='quoadult10' size='12' value='$var10[QuoAdult]' style='text-align:right' onkeyup='isNumber(this);UpdateSellA(10)' ";
        if ($var10[Description] == '') {
            echo "readonly";
        }
        echo "></td>
        ...
        $tampil = mssql_query("SELECT Currency FROM AgingKursDetails Group by Currency ORDER BY Currency ASC");
        while ($s = mssql_fetch_array($tampil)) {
            if ($s[Currency] == $var11[QuotationCurr]) {
                echo "<option value='$s[Currency]' selected>$s[Currency]</option>";
            } else {
                echo "<option value='$s[Currency]' >$s[Currency]</option>";
            }
        ...
        echo "</select><input type='hidden' name='sellingoperator11' size='3' value='$var11[SellingOperator]' > x
                     ...
                     </td><td><input type=text name='quoadult11' size='12' value='$var11[QuoAdult]' style='text-align:right' onkeyup='isNumber(this);UpdateSellA(11)' ";
        if ($var11[Description] == '') {
            echo "readonly";
        }
        echo "></td>
        ...
        $tampil = mssql_query("SELECT Currency FROM AgingKursDetails Group by Currency ORDER BY Currency ASC");
        while ($s = mssql_fetch_array($tampil)) {
            if ($s[Currency] == $var12[QuotationCurr]) {
                echo "<option value='$s[Currency]' selected>$s[Currency]</option>";
            } else {
                echo "<option value='$s[Currency]' >$s[Currency]</option>";
            }
        ...
        echo "</select><input type='hidden' name='sellingoperator12' size='3' value='$var12[SellingOperator]' > x
                     ...
                     </td><td><input type=text name='quoadult12' size='12' value='$var12[QuoAdult]' style='text-align:right' onkeyup='isNumber(this);UpdateSellA(12)' ";
        ...
        $tampil = mssql_query("SELECT Currency FROM AgingKursDetails Group by Currency ORDER BY Currency ASC");
        while ($s = mssql_fetch_array($tampil)) {
            if ($s[Currency] == $var13[QuotationCurr]) {
                echo "<option value='$s[Currency]' selected>$s[Currency]</option>";
            } else {
                echo "<option value='$s[Currency]' >$s[Currency]</option>";
            }
        ...
        echo "</select><input type='hidden' name='sellingoperator13' size='3' value='$var13[SellingOperator]' > x
                     ...
                     </td><td><input type=text name='quoadult13' size='12' value='$var13[QuoAdult]' style='text-align:right' onkeyup='isNumber(this);UpdateSellA(13)' ";
        if ($var13[Description] == '') {
            echo "readonly";
        }
        echo "></td>
        ...
        $tampil = mssql_query("SELECT Currency FROM AgingKursDetails Group by Currency ORDER BY Currency ASC");
        while ($s = mssql_fetch_array($tampil)) {
            if ($s[Currency] == $var14[QuotationCurr]) {
                echo "<option value='$s[Currency]' selected>$s[Currency]</option>";
            } else {
                echo "<option value='$s[Currency]' >$s[Currency]</option>";
            }
        ...
        echo "</select><input type='hidden' name='sellingoperator14' size='3' value='$var14[SellingOperator]' > x
                     ...
                     </td><td><input type=text name='quoadult14' size='12' value='$var14[QuoAdult]' style='text-align:right' onkeyup='isNumber(this);UpdateSellA(14)' ";
        if ($var14[Description] == '') {
            echo "readonly";
        }
        echo "></td>
        ...
        $tampil = mssql_query("SELECT Currency FROM AgingKursDetails Group by Currency ORDER BY Currency ASC");
        while ($s = mssql_fetch_array($tampil)) {
            if ($s[Currency] == $var15[QuotationCurr]) {
                echo "<option value='$s[Currency]' selected>$s[Currency]</option>";
            } else {
                echo "<option value='$s[Currency]' >$s[Currency]</option>";
            }
        ...
        echo "</select><input type='hidden' name='sellingoperator15' size='3' value='$var15[SellingOperator]' > x
                     ...
                     </td><td><input type=text name='quoadult15' size='12' value='$var15[QuoAdult]' style='text-align:right' onkeyup='isNumber(this);UpdateSellA(15)' ";
        if ($var15[Description] == '') {
            echo "readonly";
        }
        echo "></td>
    ...
    case "save":
        ...
        mysql_query("UPDATE tour_msdetail set TotalVar = '$_POST[totalvaradult]'
