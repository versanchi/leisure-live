...
switch($_GET[act]){
    ...
    default:
        ...
        //cek banyak data
        $datafix=mysql_query("SELECT * FROM tour_detailfinal where Category = 'FIX' and IDProduct = '$r[IDProduct]'");
        ...
        echo "<h2>FIX COST - $r[TourCode]</h2>
          <form method=POST name='calculate' action='?module=quotationfin&act=save'>
        ...
        if($totfix[TotalFixAdult] > 0 OR $totfix[TotalFixChd] > 0){$tampil1='enable';}else{$tampil1='disabled';}
        echo "<table class='bordered' id='fixed_hdr2'>
        <thead><th></th><th></th><th></th><th colspan='4'></th></thead>
...
<tbody>
        ...
        echo"<input type='hidden' name='sellingoperator1' size='3' value='$fix1[SellingOperator]' > x
                     ...
                     <input type=text name='quoadult1' size='12' value='$fix1[QuoAdult]' style='text-align:right' onkeyup='isNumber(this);UpdateSellA(1)' ";if($fix1[Description]==''){echo"readonly";}echo">
                     ...
                     <td><input type=text name='quochd1' size='12' value='$fix1[QuoChd]' style='text-align:right' onkeyup='isNumber(this);UpdateSellC(1)' ";if($fix1[Description]==''){echo"readonly";}echo"></td>
        ...
        echo "</select><input type='hidden' name='sellingoperator2' size='3' value='$fix2[SellingOperator]' > x
                                <input type='text' style='border: hidden;' name='sellingrate2' size='10' value='$fix2[SellingRate]' readonly>
                     </td><td>
                     <input type=text name='quoadult2' size='12' value='$fix2[QuoAdult]' style='text-align:right' onkeyup='isNumber(this);UpdateSellA(2)' ";if($fix2[Description]==''){echo"readonly";}echo">
                     ...
                     <td><input type=text name='quochd2' size='12' value='$fix2[QuoChd]' style='text-align:right' onkeyup='isNumber(this);UpdateSellC(2)' ";if($fix2[Description]==''){echo"readonly";}echo"></td>
        ...
        echo "</select><input type='hidden' name='sellingoperator3' size='3' value='$fix3[SellingOperator]' > x
                                <input type='text' style='border: hidden;' name='sellingrate3' size='10' value='$fix3[SellingRate]' readonly>
                     </td><td>
                     <input type=text name='quoadult3' size='12' value='$fix3[QuoAdult]' style='text-align:right' onkeyup='isNumber(this);UpdateSellA(3)' ";if($fix3[Description]==''){echo"readonly";}echo">
                     ...
                     <td><input type=text name='quochd3' size='12' value='$fix3[QuoChd]' style='text-align:right' onkeyup='isNumber(this);UpdateSellC(3)' ";if($fix3[Description]==''){echo"readonly";}echo"></td>
        ...
        echo "</select><input type='hidden' name='sellingoperator4' size='3' value='$fix4[SellingOperator]' > x
                                <input type='text' style='border: hidden;' name='sellingrate4' size='10' value='$fix4[SellingRate]' readonly>
                     </td><td>
                     <input type=text name='quoadult4' size='12' value='$fix4[QuoAdult]' style='text-align:right' onkeyup='isNumber(this);UpdateSellA(4)' ";if($fix4[Description]==''){echo"readonly";}echo">
                     ...
                     <td><input type=text name='quochd4' size='12' value='$fix4[QuoChd]' style='text-align:right' onkeyup='isNumber(this);UpdateSellC(4)' ";if($fix4[Description]==''){echo"readonly";}echo"></td>
        ...
        echo "</select><input type='hidden' name='sellingoperator5' size='3' value='$fix5[SellingOperator]' > x
                                <input type='text' style='border: hidden;' name='sellingrate5' size='10' value='$fix5[SellingRate]' readonly>
                     </td><td>
                     <input type=text name='quoadult5' size='12' value='$fix5[QuoAdult]' style='text-align:right' onkeyup='isNumber(this);UpdateSellA(5)' ";if($fix5[Description]==''){echo"readonly";}echo">
                     ...
                     <td><input type=text name='quochd5' size='12' value='$fix5[QuoChd]' style='text-align:right' onkeyup='isNumber(this);UpdateSellC(5)' ";if($fix5[Description]==''){echo"readonly";}echo"></td>
        ...
        echo "</select><input type='hidden' name='sellingoperator6' size='3' value='$fix6[SellingOperator]' > x
                                <input type='text' style='border: hidden;' name='sellingrate6' size='10' value='$fix6[SellingRate]' readonly>
                     </td><td>
                     <input type=text name='quoadult6' size='12' value='$fix6[QuoAdult]' style='text-align:right' onkeyup='isNumber(this);UpdateSellA(6)' ";if($fix6[Description]==''){echo"readonly";}echo">
                     ...
                     <td><input type=text name='quochd6' size='12' value='$fix6[QuoChd]' style='text-align:right' onkeyup='isNumber(this);UpdateSellC(6)' ";if($fix6[Description]==''){echo"readonly";}echo"></td>
        ...
        echo "</select><input type='hidden' name='sellingoperator7' size='3' value='$fix7[SellingOperator]' > x
                                <input type='text' style='border: hidden;' name='sellingrate7' size='10' value='$fix7[SellingRate]' readonly>
                     </td><td>
                     <input type=text name='quoadult7' size='12' value='$fix7[QuoAdult]' style='text-align:right' onkeyup='isNumber(this);UpdateSellA(7)' ";if($fix7[Description]==''){echo"readonly";}echo">
                     ...
                     <td><input type=text name='quochd7' size='12' value='$fix7[QuoChd]' style='text-align:right' onkeyup='isNumber(this);UpdateSellC(7)' ";if($fix7[Description]==''){echo"readonly";}echo"></td>
        ...
        echo "</select><input type='hidden' name='sellingoperator8' size='3' value='$fix8[SellingOperator]' > x
                                <input type='text' style='border: hidden;' name='sellingrate8' size='10' value='$fix8[SellingRate]' readonly>
                     </td><td>
                     <input type=text name='quoadult8' size='12' value='$fix8[QuoAdult]' style='text-align:right' onkeyup='isNumber(this);UpdateSellA(8)' ";if($fix8[Description]==''){echo"readonly";}echo">
                     ...
                     <td><input type=text name='quochd8' size='12' value='$fix8[QuoChd]' style='text-align:right' onkeyup='isNumber(this);UpdateSellC(8)' ";if($fix8[Description]==''){echo"readonly";}echo"></td>
        ...
        echo "</select><input type='hidden' name='sellingoperator9' size='3' value='$fix9[SellingOperator]' > x
                                <input type='text' style='border: hidden;' name='sellingrate9' size='10' value='$fix9[SellingRate]' readonly>
                     </td><td>
                     <input type=text name='quoadult9' size='12' value='$fix9[QuoAdult]' style='text-align:right' onkeyup='isNumber(this);UpdateSellA(9)' ";if($fix9[Description]==''){echo"readonly";}echo">
                     ...
                     <td><input type=text name='quochd9' size='12' value='$fix9[QuoChd]' style='text-align:right' onkeyup='isNumber(this);UpdateSellC(9)' ";if($fix9[Description]==''){echo"readonly";}echo"></td>
        ...
        echo "</select><input type='hidden' name='sellingoperator10' size='3' value='$fix10[SellingOperator]' > x
                                <input type='text' style='border: hidden;' name='sellingrate10' size='10' value='$fix10[SellingRate]' readonly>
                     </td><td>
                     <input type=text name='quoadult10' size='12' value='$fix10[QuoAdult]' style='text-align:right' onkeyup='isNumber(this);UpdateSellA(10)' ";if($fix10[Description]==''){echo"readonly";}echo">
                     ...
                     <td><input type=text name='quochd10' size='12' value='$fix10[QuoChd]' style='text-align:right' onkeyup='isNumber(this);UpdateSellC(10)' ";if($fix10[Description]==''){echo"readonly";}echo"></td>
        ...
        echo "</select>
             <input type='hidden' name='sellingoperator11' size='3' value='$fix11[SellingOperator]' > x
                     <input type='text' style='border: hidden;' name='sellingrate11' size='10' value='$fix11[SellingRate]' readonly>
                     </td><td>
                     <input type=text name='quoadult11' size='12' value='$fix11[QuoAdult]' style='text-align:right' onkeyup='isNumber(this);UpdateSellA(11)' ";if($fix11[Description]==''){echo"readonly";}echo">
                     ...
                     <td><input type=text name='quochd11' size='12' value='$fix11[QuoChd]' style='text-align:right' onkeyup='isNumber(this);UpdateSellC(11)' ";if($fix11[Description]==''){echo"readonly";}echo"></td>
        ...
        echo "</select>
             <input type='hidden' name='sellingoperator12' size='3' value='$fix12[SellingOperator]' > x
                     <input type='text' style='border: hidden;' name='sellingrate12' size='10' value='$fix12[SellingRate]' readonly>
                     </td><td>
                     <input type=text name='quoadult12' size='12' value='$fix12[QuoAdult]' style='text-align:right' onkeyup='isNumber(this);UpdateSellA(12)' ";if($fix12[Description]==''){echo"readonly";}echo">
                     ...
                     <td><input type=text name='quochd12' size='12' value='$fix12[QuoChd]' style='text-align:right' onkeyup='isNumber(this);UpdateSellC(12)' ";if($fix12[Description]==''){echo"readonly";}echo"></td>
        ...
        echo "</select>
                <input type='hidden' name='sellingoperator13' size='3' value='$fix13[SellingOperator]' > x
                <input type='text' style='border: hidden;' name='sellingrate13' size='10' value='$fix13[SellingRate]' readonly>
                     </td><td>
                     <input type=text name='quoadult13' size='12' value='$fix13[QuoAdult]' style='text-align:right' onkeyup='isNumber(this);UpdateSellA(13)' ";if($fix13[Description]==''){echo"readonly";}echo">
                     ...
                     <td><input type=text name='quochd13' size='12' value='$fix13[QuoChd]' style='text-align:right' onkeyup='isNumber(this);UpdateSellC(13)' ";if($fix13[Description]==''){echo"readonly";}echo"></td>
        ...
        echo "</select><input type='hidden' name='sellingoperator14' size='3' value='$fix14[SellingOperator]' > x
                                <input type='text' style='border: hidden;' name='sellingrate14' size='10' value='$fix14[SellingRate]' readonly>
                     </td><td>
                     <input type=text name='quoadult14' size='12' value='$fix14[QuoAdult]' style='text-align:right' onkeyup='isNumber(this);UpdateSellA(14)' ";if($fix14[Description]==''){echo"readonly";}echo">
                     ...
                     <td><input type=text name='quochd14' size='12' value='$fix14[QuoChd]' style='text-align:right' onkeyup='isNumber(this);UpdateSellC(14)' ";if($fix14[Description]==''){echo"readonly";}echo"></td>
        ...
        echo "</select><input type='hidden' name='sellingoperator15' size='3' value='$fix15[SellingOperator]' > x
                                <input type='text' style='border: hidden;' name='sellingrate15' size='10' value='$fix15[SellingRate]' readonly>
                     </td><td>
                     <input type=text name='quoadult15' size='12' value='$fix15[QuoAdult]' style='text-align:right' onkeyup='isNumber(this);UpdateSellA(15)' ";if($fix15[Description]==''){echo"readonly";}echo">
                     ...
                     <td><input type=text name='quochd15' size='12' value='$fix15[QuoChd]' style='text-align:right' onkeyup='isNumber(this);UpdateSellC(15)' ";if($fix15[Description]==''){echo"readonly";}echo"></td>
    ...
    case "save":
        ...
        mysql_query("UPDATE tour_msdetailfinal set TotalFixAdult = '$_POST[totalfixadult]',
