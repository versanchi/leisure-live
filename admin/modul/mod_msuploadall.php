...
//			$test=($_POST['list_prod'][$i]);
			...
			mysql_query("INSERT INTO infoprod (infofile,infopath,infoupdate,infocountry,description) 
						VALUES ('$name',
								'$fullpath',
								'$date','$emb','$pid')");
...
<p><form name="myForm" action="<?php  echo './media.php?module=msuploadall'; ?>" method="POST" enctype="multipart/form-data" > 
      
<fieldset> 
<legend><font size=3 color=red  >Upload General Files</font></legend>   

<p>Description &nbsp&nbsp&nbsp&nbsp : <input type="text" name="description" />
