...
switch($_GET[act]){
  // Tampil Office
   ...
   echo "<h2>Performance Travel Consultant </h2>
          <form method='get' action='media.php?'><input type=hidden name=module value='rpttcdiv'>
    ...
    echo "</select>";
	 echo "<br>TC Level : <select name='RankTC'>
			...
			<input type='hidden' name ='Division' value='$_SESSION[employee_office]'>
