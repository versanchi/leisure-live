...
$ltmauthority=$tampiluser[LTMAuthority];
$timezone_offset = -1;
...
switch($_GET['act']) {
    ...
    case "tambahmsproduct":
        ...
        $tampil = mysql_query("SELECT * FROM doa_product where Status = '1' AND ProductType='VISA' group by CountryName ORDER BY CountryName");
        while ($r = mysql_fetch_array($tampil)) {
            echo "<option value='$r[CountryName],$r[EstimateVisaGroup]'>$r[CountryName]</option>";
        }
    ...
    case "editmsproduct":
        ...
        while ($s = mysql_fetch_array($tampil)) {
            if ($r[Embassy01] == $s[CountryName]) {
                $qid = mysql_query("SELECT * FROM doa_product where CountryName = '$r[Embassy01]' group by CountryName");
                $idemb = mysql_fetch_array($qid);
                $idembassy1 = $idemb[CountryName];
                $visarange1 = $idemb[VisaTimeFrame];
                if ($visarange1 == '') {
                    $visarange1 = '0';
                } else {
                    $visarange1 = $visarange1;
                }
                echo "<option value='$s[CountryName],$s[VisaTimeFrame]' selected>$s[CountryName]</option>";
            } else {
                $visarange1 = '0';
                echo "<option value='$s[CountryName],$s[VisaTimeFrame]'>$s[CountryName]</option>";
            }
        }
        ...
        while ($s = mysql_fetch_array($tampil)) {
            if ($r[Embassy03] == $s[CountryName]) {
                $qid = mysql_query("SELECT * FROM doa_product where CountryName = '$r[Embassy03]' group by CountryName");
                $idemb = mysql_fetch_array($qid);
                $idembassy3 = $idemb[CountryName];
                $visarange3 = $idemb[VisaTimeFrame];
                if ($visarange3 == '') {
                    $visarange3 = '0';
                } else {
        ...
        while ($s = mysql_fetch_array($tampil)) {
            if ($r[Embassy05] == $s[CountryName]) {
                $qid = mysql_query("SELECT * FROM doa_product where CountryName = '$r[Embassy05]' group by CountryName");
                $idemb = mysql_fetch_array($qid);
                $idembassy5 = $idemb[CountryName];
                $visarange5 = $idemb[VisaTimeFrame];
                if ($visarange5 == '') {
                    $visarange5 = '0';
                } else {
        ...
        while ($s = mysql_fetch_array($tampil)) {
            if ($r[Embassy02] == $s[CountryName]) {
                $qid = mysql_query("SELECT * FROM doa_product where CountryName = '$r[Embassy02]' group by CountryName");
                $idemb = mysql_fetch_array($qid);
                $idembassy2 = $idemb[CountryName];
                $visarange2 = $idemb[VisaTimeFrame];
                if ($visarange2 == '') {
                    $visarange2 = '0';
                } else {
        ...
        while ($s = mysql_fetch_array($tampil)) {
            if ($r[Embassy04] == $s[CountryName]) {
                $qid = mysql_query("SELECT * FROM doa_product where CountryName = '$r[Embassy04]' group by CountryName ");
                $idemb = mysql_fetch_array($qid);
                $idembassy4 = $idemb[CountryName];
                $visarange4 = $idemb[VisaTimeFrame];
                if ($visarange4 == '') {
                    $visarange4 = '0';
                } else {
    ...
    case "editmsproductapp":
        ...
        echo "</td></tr>
            <tr><td>Handle By</td><td>
            ";
        if ($r[Department] == 'LEISURE') {
            echo "Leisure";
        } else if ($r[Department] == 'MINISTRY') {
            echo "Ministry";
        }
        echo "</td></tr>
            <tr><td>Product Type</td> <td>";
        ...
        echo "</td></tr>
            <tr><td>Visa Time Limit</td><td><input type=text value='$VisaDateLine' name='visadateline' size='10'  onClick=" . "cal.select(document.forms['example'].visadateline,'anchor3','dd-MM-yyyy'); return false;" . " NAME='anchor3' ID='anchor3'> <font color='red'>(dd-mm-yyyy)</font></td></tr>
            <tr><td>Selling</td><td>Currency : $r[SellingCurr] </td></tr>";
        $file = preg_replace("[^a-z0-9._]", "", str_replace(" ", "_", str_replace("%20", "_", strtolower($r[AttachmentFile]))));
    ...
    case "appmsproduct":
        ...
        // Langkah 2   AND DateTravelFrom > '$hari'
        if ($offcat == 'SYSTEM DEVELOPER' OR $offcat == 'PRODUCT') {
            $tampil = mysql_query("SELECT * FROM tour_msproduct
                                WHERE $opnama LIKE '%$nama%'
                                AND Status <> 'VOID'
...
// quotation awal
    case "quotation":
        ...
        if ($r[Embassy01] <> '0') {
            $qemb1 = mysql_query("SELECT * FROM tbl_msembassy where CountryID = '$r[Embassy01]'");
            $emb1 = mysql_fetch_array($qemb1);
            if($emb1[Country]<>''){
                $embCountryName1=$emb1[Country];
            }else{
                $nqemb1 = mysql_query("SELECT * FROM doa_product where CountryName = '$r[Embassy01]' and Status = '1' AND ProductType='VISA' group by CountryName ORDER BY CountryName");
                $nemb1 = mysql_fetch_array($nqemb1);
                $embCountryName1=$nemb1[CountryName];
            }
            echo "<tr><td>Visa $embCountryName1</td><td></td><td></td><td> <input type=text name='visanett' size='12'";
            if ($r[Visa] == 'NO REQUIRED') {
                echo "disabled";
            }
        ...
        if ($r[Embassy02] <> '0') {
            $qemb2 = mysql_query("SELECT * FROM tbl_msembassy where CountryID = '$r[Embassy02]'");
            $emb2 = mysql_fetch_array($qemb2);
            if($emb2[Country]<>''){
                $embCountryName2=$emb2[Country];
            }else{
                $nqemb2 = mysql_query("SELECT * FROM doa_product where CountryName = '$r[Embassy02]' and Status = '1' AND ProductType='VISA' group by CountryName ORDER BY CountryName");
                $nemb2 = mysql_fetch_array($nqemb2);
                $embCountryName2=$nemb2[CountryName];
            }
            echo "<tr><td>Visa $embCountryName2</td><td></td><td></td><td> <input type=text name='visanett2' size='12'";
            if ($r[Visa] == 'NO REQUIRED') {
                echo "disabled";
            }
        ...
        if ($r[Embassy03] <> '0') {
            $qemb3 = mysql_query("SELECT * FROM tbl_msembassy where CountryID = '$r[Embassy03]'");
            $emb3 = mysql_fetch_array($qemb3);
            if($emb3[Country]<>''){
                $embCountryName3=$emb3[Country];
            }else{
                $nqemb3 = mysql_query("SELECT * FROM doa_product where CountryName = '$r[Embassy03]' and Status = '1' AND ProductType='VISA' group by CountryName ORDER BY CountryName");
                $nemb3 = mysql_fetch_array($nqemb3);
                $embCountryName3=$nemb3[CountryName];
            }
            echo "<tr><td>Visa $embCountryName3</td><td></td><td></td><td> <input type=text name='visanett3' size='12'";
            if ($r[Visa] == 'NO REQUIRED') {
                echo "disabled";
            }
        ...
        if ($r[Embassy04] <> '0') {
            $qemb4 = mysql_query("SELECT * FROM tbl_msembassy where CountryID = '$r[Embassy04]'");
            $emb4 = mysql_fetch_array($qemb4);
            if($emb4[Country]<>''){
                $embCountryName4=$emb4[Country];
            }else{
                $nqemb4 = mysql_query("SELECT * FROM doa_product where CountryName = '$r[Embassy04]' and Status = '1' AND ProductType='VISA' group by CountryName ORDER BY CountryName");
                $nemb4 = mysql_fetch_array($nqemb4);
                $embCountryName4=$nemb4[CountryName];
            }
            echo "<tr><td>Visa $embCountryName4</td><td></td><td></td><td> <input type=text name='visanett4' size='12'";
            if ($r[Visa] == 'NO REQUIRED') {
                echo "disabled";
            }
        ...
        if ($r[Embassy05] <> '0') {
            $qemb5 = mysql_query("SELECT * FROM tbl_msembassy where CountryID = '$r[Embassy05]'");
            $emb5 = mysql_fetch_array($qemb5);
            if($emb5[Country]<>''){
                $embCountryName5=$emb5[Country];
            }else{
                $nqemb5 = mysql_query("SELECT * FROM doa_product where CountryName = '$r[Embassy05]' and Status = '1' AND ProductType='VISA' group by CountryName ORDER BY CountryName");
                $nemb5 = mysql_fetch_array($nqemb5);
                $embCountryName5=$nemb5[CountryName];
            }
            echo "<tr><td>Visa $embCountryName5</td><td></td><td></td><td> <input type=text name='visanett5' size='12'";
            if ($r[Visa] == 'NO REQUIRED') {
                echo "disabled";
            }
...
// final quotation
    ...
    case "showquotation":
        ...
        $paa=number_format(($nettaa*$data[Persen])/100, 0, '', '');
        $pca=number_format(($nettca*$data[Persen])/100, 0, '', '');
        $pcxa=number_format(($nettcxa*$data[Persen])/100, 0, '', '');
        $pcna=number_format(($nettcna*$data[Persen])/100, 0, '', '');
        $pab=number_format(($nettab*$data[Persen])/100, 0, '', '');
        $pcb=number_format(($nettcb*$data[Persen])/100, 0, '', '');
        $pcxb=number_format(($nettcxb*$data[Persen])/100, 0, '', '');
        $pcnb=number_format(($nettcnb*$data[Persen])/100, 0, '', '');
        $pac=number_format(($nettac*$data[Persen])/100, 0, '', '');
        $pcc=number_format(($nettcc*$data[Persen])/100, 0, '', '');
        $pcxc=number_format(($nettcxc*$data[Persen])/100, 0, '', '');
        $pcnc=number_format(($nettcnc*$data[Persen])/100, 0, '', '');
        ...
        echo "
          ...
          <tr><td>Visa </td><td>$r[VisaCurr]</td><td> <input type=text name='visanett' size='12' value='$r[VisaNett]' style='text-align: right;border: 0px solid #000000;' readonly></td><td><input type=text name='visasell' size='12'";
        if ($r[Visa] == 'NO REQUIRED') {
            echo "disabled";
        }
        echo " value='$r[VisaSell]' style='text-align: right;border: 0px solid #000000;' readonly></td></tr>
          <tr><td>Domestic Airport Tax</td><td>$r[AirTaxCurr]</td><td><input type=text name='airtaxnett' size='12' value='$r[AirTaxNett]' style='text-align: right;border: 0px solid #000000;' readonly></td><td> <input type=text name='airtaxsell' size='12' value='$r[AirTaxSell]' style='text-align: right;border: 0px solid #000000;' readonly></td></tr>
          ...
          <input type=hidden name=id value='$r[IDProduct]'>";
        if (($ltmauthority == 'LEISURE ADMINISTRATOR' or $EmpOff == 'IFM') AND $r[QuotationStatus] <> 'LOCK') {
    ...
    case "prodflight":
        ...
        $tampil = mysql_query("SELECT GrvAirlines FROM tour_msgrv where GrvStatus <> 'VOID' Group by GrvAirlines ORDER BY GrvAirlines ASC");
        while ($s = mysql_fetch_array($tampil)) {
    ...
    case "reqmsproduct":
        ...
        if ($tmrno <> '') {
            $producttypeb = 'TAILOR MADE REQUEST';
            echo "
        ...
        if (isset($_POST['redirected'])) {
            ...
            echo $tmrr[DateTravelFrom];
        }
        echo "'  name='datetravelfrom' size='10' onfocus='selisih()' onClick=" . "cal.select(document.forms['example'].datetravelfrom,'ActIn1','yyyy-MM-dd'); return false;" . " NAME='anchor3' ID='ActIn1'>
           <font color='red'>(yyyy-mm-dd)</font>
          - To <input type=text value='";
        if (isset($_POST['redirected'])) {
            echo $_POST['datetravelto'];
        } else if ($tmrno <> '') {
            echo $tmrr[DateTravelTo];
        }
        echo "' name='datetravelto' size='10' onfocus='selisih()' onClick=" . "cal.select(document.forms['example'].datetravelto,'anchor2','yyyy-MM-dd'); return false;" . " NAME='anchor2' ID='anchor2'>
           <font color='red'>(yyyy-mm-dd)</font></td></tr>
           <tr><td>Number of Days</td> <td><input type=text name='daystravel' id='daystravel' value='";
        if (isset($_POST['redirected'])) {
            echo $_POST['daystravel'];
        } else if ($tmrno <> '') {
            echo $tmrr[DaysTravel];
        }
        echo "' size='3'> days</td></tr>
          <tr><td>Flight</td> <td>  <select name='flight' onChange='turcode()'>
            <option value='0' selected>- Select Airlines -</option>";
        ...
        if (isset($_POST['redirected'])) {
            ...
            $tmrseat = $tmrr[Seat] + $tmrr[SeatChild];
            echo $tmrseat;
        }
        echo "' name='seat' size='3' onkeyup='isNumber(this)'> Pax <font color='red'>*<i>Not Include Infant and Tour leader</i></font></td></tr>
          <tr><td>Tour Leader</td> <td>";
    ...
    case "input":
        ...
        if ($ketemu > 0) {
            ...
            if ($new_name == '') {
                ...
                $cuma = mysql_query("SELECT * FROM tour_msproduct
        ...
        if ($_POST[attachmentfile] <> '') {
            ...
            mysql_query("INSERT INTO tbl_logtour(EmployeeName,
                        ...
                        VALUES ('$EmpName',
                               ...
                               '$today')");
            //header('location:media.php?module=' . $module);
            echo "<META HTTP-EQUIV='Refresh' Content='0; URL=?module=$module'>";
        } else {
            $tmp_name = $_FILES['upload']['tmp_name'];
            $new_name = $_FILES['upload']['name'];
            $fullpath = "./itin/";
