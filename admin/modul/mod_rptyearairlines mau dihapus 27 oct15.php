...
while($DBooking=mysql_fetch_array($Booking)){
  ...
  //munculin table
	 ...
	 echo" <div class='xscrolling-wrapper'>
	 		<div class='left-div'>
	 			<table>
	 				<tr class='main-label'>
	...
	foreach ($DBookingList as $DBooking) {
	...
	echo "
	 		...
	 		<table style='width: 1200px; max-width: 1200px; margin-left: 88px; white-space: nowrap;'>
			<tr><th colspan=3>JAN</th><th colspan=3>FEB</th><th colspan=3>MAR</th><th colspan=3>APR</th><th colspan=3>MAY</th><th colspan=3>JUN</th><th colspan=3>JUL</th><th colspan=3>AGT</th><th colspan=3>SEP</th><th colspan=3>OCT</th><th colspan=3>NOV</th><th colspan=3>DEC</th><th colspan=3>TOTAL</th></tr>
