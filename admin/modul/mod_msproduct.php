...
<script type="text/javascript">
    ...
    function cekmoment() {   a = document.example.elements['producttype'].value;
        if(a=='TUR EZ'){document.example.elements['moments'].checked=false;}
        else {document.example.elements['moments'].checked=true;}

    }
    function visaselllock(a){
        var visano = "visaemb0"+a;
        var sellno = "visasell"+a;
        if(a==0) {
            if(document.getElementById('visaemb01').value == 0) {
                document.getElementById('visasell').readOnly = false;
            }else{
                document.getElementById('visasell').readOnly = true;
            }
        }else{
            if(document.getElementById(visano).value == 0) {
                document.getElementById(sellno).readOnly = false;
            }else{
                document.getElementById(sellno).readOnly = true;
            }
        }
    }
    function PriceVisa1() {
        <?PHP
        $query = "SELECT * FROM doa_product_price WHERE Status ='ACTIVE' ";
        $hasil = mysql_query($query);
        ...
        while ($data = mysql_fetch_array($hasil))
        {
            $idDest = $data['Id'];
            // membuat IF untuk masing-masing currency
            echo "if (document.getElementById('visaemb01').value == '$idDest')";
            echo "{";
            $query2 = "SELECT * FROM doa_product_price WHERE Id = '$idDest' ";
            $hasil2 = mysql_query($query2);
            $data2 = mysql_fetch_array($hasil2);
            $content = "document.getElementById('visasell').value='$data2[SellingValueInRupiah]'";
            echo $content;
            echo "}\n";
            echo "else if (document.getElementById('visaemb01').value == '0'){";
            $content = "document.getElementById('visasell').value='0'";
            echo $content;
            echo "}\n";
        }
        ?>
    ...
    function PriceVisa2() {
        ...
        while ($data = mysql_fetch_array($hasil))
        {
            $idDest = $data['Id'];
            // membuat IF untuk masing-masing currency
            echo "if (document.getElementById('visaemb02').value == '$idDest')";
            echo "{";
            $query2 = "SELECT * FROM doa_product_price WHERE Id = '$idDest' ";
            $hasil2 = mysql_query($query2);
            $data2 = mysql_fetch_array($hasil2);
            $content = "document.getElementById('visasell2').value='$data2[SellingValueInRupiah]'";
            echo $content;
            echo "}\n";
            echo "else if (document.getElementById('visaemb02').value == '0'){";
            $content = "document.getElementById('visasell2').value='0'";
            echo $content;
            echo "}\n";
        }
        ?>
    ...
    function PriceVisa3() {
        ...
        while ($data = mysql_fetch_array($hasil))
        {
            $idDest = $data['Id'];
            // membuat IF untuk masing-masing currency
            echo "if (document.getElementById('visaemb03').value == '$idDest')";
            echo "{";
            $query2 = "SELECT * FROM doa_product_price WHERE Id = '$idDest' ";
            $hasil2 = mysql_query($query2);
            $data2 = mysql_fetch_array($hasil2);
            $content = "document.getElementById('visasell3').value='$data2[SellingValueInRupiah]'";
            echo $content;
            echo "}\n";
            echo "else if (document.getElementById('visaemb03').value == '0'){";
            $content = "document.getElementById('visasell3').value='0'";
            echo $content;
            echo "}\n";
        }
        ?>
    ...
    function PriceVisa4() {
        ...
        while ($data = mysql_fetch_array($hasil))
        {
            $idDest = $data['Id'];
            // membuat IF untuk masing-masing currency
            echo "if (document.getElementById('visaemb04').value == '$idDest')";
            echo "{";
            $query2 = "SELECT * FROM doa_product_price WHERE Id = '$idDest' ";
            $hasil2 = mysql_query($query2);
            $data2 = mysql_fetch_array($hasil2);
            $content = "document.getElementById('visasell4').value='$data2[SellingValueInRupiah]'";
            echo $content;
            echo "}\n";
            echo "else if (document.getElementById('visaemb04').value == '0'){";
            $content = "document.getElementById('visasell4').value='0'";
            echo $content;
            echo "}\n";
        }
        ?>
    ...
    function PriceVisa5() {
        ...
        while ($data = mysql_fetch_array($hasil))
        {
            $idDest = $data['Id'];
            // membuat IF untuk masing-masing currency
            echo "if (document.getElementById('visaemb05').value == '$idDest')";
            echo "{";
            $query2 = "SELECT * FROM doa_product_price WHERE Id = '$idDest' ";
            $hasil2 = mysql_query($query2);
            $data2 = mysql_fetch_array($hasil2);
            $content = "document.getElementById('visasell5').value='$data2[SellingValueInRupiah]'";
            echo $content;
            echo "}\n";
            echo "else if (document.getElementById('visaemb05').value == '0'){";
            $content = "document.getElementById('visasell5').value='0'";
            echo $content;
            echo "}\n";
        }
        ?>
...
switch($_GET['act']) {
    ...
    case "tambahmsproduct":
        ...
        echo "'  name='datetravelfrom' size='10' onfocus='selisih()' onblur='kopitgl()' onClick=" . "cal.select(document.forms['example'].datetravelfrom,'ActIn1','dd-MM-yyyy'); return false;" . " NAME='anchor3' ID='ActIn1'>
           <font color='red'>(dd-mm-yyyy)</font>
          - To <input type=text value='";
        if (isset($_POST['redirected'])) {
            echo $_POST['datetravelto'];
        }
        echo "' name='datetravelto' size='10' onfocus='selisih()' onClick=" . "cal.select(document.forms['example'].datetravelto,'anchor2','dd-MM-yyyy'); return false;" . " NAME='anchor2' ID='anchor2'>
        ...
        // tidak boleh diganti ke product doa karena ada VOA
    ...
    case "editmsproduct":
        ...
        $tampil = mssql_query("SELECT Country FROM Destination where Active = '1' GROUP BY Country ORDER BY Country");
        while ($s = mssql_fetch_array($tampil)) {
            if ($r[Embassy01] == $s[Country]) {
                $qid = mssql_query("SELECT Country FROM Destination where Country = '$r[Embassy01]' GROUP BY Country ORDER BY Country ");
                $idemb = mssql_fetch_array($qid);
                $idembassy1 = $idemb[Country];
                $visarange1 = 14;
                if ($visarange1 == '') {
                    $visarange1 = '0';
                } else {
                ...
                echo "<option value='$s[Country],14' selected>$s[Country]</option>";
            } else {
                $visarange1 = '0';
                echo "<option value='$s[Country],14'>$s[Country]</option>";
            }
        }
        ...
        $tampil = mssql_query("SELECT Country FROM Destination where Active = '1' GROUP BY Country ORDER BY Country");
        while ($s = mssql_fetch_array($tampil)) {
            if ($r[Embassy03] == $s[Country]) {
                $qid = mssql_query("SELECT Country FROM Destination where Country = '$r[Embassy03]' GROUP BY Country ORDER BY Country ");
                $idemb = mssql_fetch_array($qid);
                $idembassy3 = $idemb[Country];
                $visarange3 = 14;
                if ($visarange3 == '') {
                    $visarange3 = '0';
                } else {
        ...
        $tampil = mssql_query("SELECT Country FROM Destination where Active = '1' GROUP BY Country ORDER BY Country");
        while ($s = mssql_fetch_array($tampil)) {
            if ($r[Embassy05] == $s[Country]) {
                $qid = mssql_query("SELECT Country FROM Destination where Country = '$r[Embassy05]' GROUP BY Country ORDER BY Country ");
                $idemb = mssql_fetch_array($qid);
                $idembassy5 = $idemb[Country];
                $visarange5 = 14;
                if ($visarange5 == '') {
                    $visarange5 = '0';
                } else {
        ...
        $tampil = mssql_query("SELECT Country FROM Destination where Active = '1' GROUP BY Country ORDER BY Country");
        while ($s = mssql_fetch_array($tampil)) {
            if ($r[Embassy02] == $s[Country]) {
                $qid = mssql_query("SELECT Country FROM Destination where Country = '$r[Embassy02]' GROUP BY Country ORDER BY Country ");
                $idemb = mssql_fetch_array($qid);
                $idembassy2 = $idemb[Country];
                $visarange2 = 14;
                if ($visarange2 == '') {
                    $visarange2 = '0';
                } else {
        ...
        $tampil = mssql_query("SELECT Country FROM Destination where Active = '1' GROUP BY Country ORDER BY Country");
        while ($s = mssql_fetch_array($tampil)) {
            if ($r[Embassy04] == $s[Country]) {
                $qid = mssql_query("SELECT Country FROM Destination where Country = '$r[Embassy04]' GROUP BY Country ORDER BY Country ");
                $idemb = mssql_fetch_array($qid);
                $idembassy4 = $idemb[Country];
                $visarange4 = 14;
                if ($visarange4 == '') {
                    $visarange4 = '0';
                } else {
...
// quotation awal
    case "quotation":
        ...
        if($r[CompanyID]=='1') {
            if ($r[Embassy01] <> '0') {
                $qvisadoa = mysql_query("SELECT SellingValueInRupiah FROM doa_product_price WHERE Id = '$r[DoaId01]' ");
                $dvisadoa = mysql_fetch_array($qvisadoa);
                if ($r[DoaId01] == '0') {
                    $sellvisa = $r[VisaSell];
                    $readsell1 = '';
                } else {
                    $sellvisa = $dvisadoa[SellingValueInRupiah];
                    $readsell1 = 'readonly';
                }
                echo "<tr><td>Visa $r[Embassy01]</td><td colspan='3'> <select name='visaemb01' id='visaemb01' onChange='PriceVisa1()'>
            <option value='0' selected>- Type -</option>";
                $qemb1 = mysql_query("SELECT B.*,C.Name FROM doa_product A
                                    INNER JOIN doa_product_price B on B.DoaProductId = A.Id
                                    INNER JOIN doa_product_price_category C on C.Id = B.DoaProductPriceCategoryId
                                    where A.ProductType='VISA' AND A.CountryName='$r[Embassy01]' 
                                    AND A.ProductCategory like '%TOURS%'
                                    AND B.Status = 'ACTIVE'
                                    ORDER BY A.CountryName");
                while ($demb1 = mysql_fetch_array($qemb1)) {
                    if ($r[DoaId01] == $demb1[Id]) {
                        echo "<option value='$demb1[Id]' selected>$demb1[Type] - $demb1[Name] - $demb1[Process] - $demb1[IsAdult]</option>";
                    } else {
                        echo "<option value='$demb1[Id]'>$demb1[Type] - $demb1[Name] - $demb1[Process] - $demb1[IsAdult]</option>";
                    }
                }
                echo "</select></td><td> <input type='hidden' name='visanett' size='12' value='$r[VisaNett]'>
          <input type='text' name='visasell' id='visasell' value=' $sellvisa' size='12' $readsell1></td></tr>";
            }
            if ($r[Embassy02] <> '0') {
                $qvisadoa = mysql_query("SELECT SellingValueInRupiah FROM doa_product_price WHERE Id = '$r[DoaId02]' ");
                $dvisadoa = mysql_fetch_array($qvisadoa);
                if ($r[DoaId02] == '0') {
                    $sellvisa = $r[VisaSell2];
                    $readsell2 = '';
                } else {
                    $sellvisa = $dvisadoa[SellingValueInRupiah];
                    $readsell2 = 'readonly';
                }
                echo "<tr><td>Visa $r[Embassy02]</td><td colspan='3'> <select name='visaemb02' id='visaemb02' onChange='PriceVisa2()'>
            <option value='0' selected>- Type -</option>";
                $qemb1 = mysql_query("SELECT B.*,C.Name FROM doa_product A
                                    INNER JOIN doa_product_price B on B.DoaProductId = A.Id
                                    INNER JOIN doa_product_price_category C on C.Id = B.DoaProductPriceCategoryId
                                    where A.ProductType='VISA' AND A.CountryName='$r[Embassy02]' 
                                    AND A.ProductCategory like '%TOURS%'
                                    AND B.Status = 'ACTIVE'
                                    ORDER BY A.CountryName");
                while ($demb1 = mysql_fetch_array($qemb1)) {
                    if ($r[DoaId02] == $demb1[Id]) {
                        echo "<option value='$demb1[Id]' selected>$demb1[Type] - $demb1[Name] - $demb1[Process] - $demb1[IsAdult]</option>";
                    } else {
                        echo "<option value='$demb1[Id]'>$demb1[Type] - $demb1[Name] - $demb1[Process] - $demb1[IsAdult]</option>";
                    }
                }
                echo "</select></td><td> <input type='hidden' name='visanett2' size='12' value='$r[VisaNett2]'>
          <input type='text' name='visasell2' id='visasell2' value='$sellvisa' size='12' $readsell2></td></tr>";
            }
            if ($r[Embassy03] <> '0') {
                $qvisadoa = mysql_query("SELECT SellingValueInRupiah FROM doa_product_price WHERE Id = '$r[DoaId03]' ");
                $dvisadoa = mysql_fetch_array($qvisadoa);
                if ($r[DoaId03] == '0') {
                    $sellvisa = $r[VisaSell3];
                    $readsell3 = '';
                } else {
                    $sellvisa = $dvisadoa[SellingValueInRupiah];
                    $readsell3 = 'readonly';
                }
                echo "<tr><td>Visa $r[Embassy03]</td><td colspan='3'> <select name='visaemb03' id='visaemb03' onChange='PriceVisa3()'>
            <option value='0' selected>- Type -</option>";
                $qemb1 = mysql_query("SELECT B.*,C.Name FROM doa_product A
                                    INNER JOIN doa_product_price B on B.DoaProductId = A.Id
                                    INNER JOIN doa_product_price_category C on C.Id = B.DoaProductPriceCategoryId
                                    where A.ProductType='VISA' AND A.CountryName='$r[Embassy03]' 
                                    AND A.ProductCategory like '%TOURS%'
                                    AND B.Status = 'ACTIVE'
                                    ORDER BY A.CountryName");
                while ($demb1 = mysql_fetch_array($qemb1)) {
                    if ($r[DoaId03] == $demb1[Id]) {
                        echo "<option value='$demb1[Id]' selected>$demb1[Type] - $demb1[Name] - $demb1[Process] - $demb1[IsAdult]</option>";
                    } else {
                        echo "<option value='$demb1[Id]'>$demb1[Type] - $demb1[Name] - $demb1[Process] - $demb1[IsAdult]</option>";
                    }
                }
                echo "</select></td><td> <input type='hidden' name='visanett3' size='12' value='$r[VisaNett3]'>
          <input type='text' name='visasell3' id='visasell3' value='$sellvisa' size='12' $readsell3></td></tr>";
            }
            if ($r[Embassy04] <> '0') {
                $qvisadoa = mysql_query("SELECT SellingValueInRupiah FROM doa_product_price WHERE Id = '$r[DoaId04]' ");
                $dvisadoa = mysql_fetch_array($qvisadoa);
                if ($r[DoaId04] == '0') {
                    $sellvisa = $r[VisaSell4];
                    $readsell4 = '';
                } else {
                    $sellvisa = $dvisadoa[SellingValueInRupiah];
                    $readsell4 = 'readonly';
                }
                echo "<tr><td>Visa $r[Embassy04]</td><td colspan='3'> <select name='visaemb04' id='visaemb04' onChange='PriceVisa4()'>
            <option value='0' selected>- Type -</option>";
                $qemb1 = mysql_query("SELECT B.*,C.Name FROM doa_product A
                                    INNER JOIN doa_product_price B on B.DoaProductId = A.Id
                                    INNER JOIN doa_product_price_category C on C.Id = B.DoaProductPriceCategoryId
                                    where A.ProductType='VISA' AND A.CountryName='$r[Embassy04]' 
                                    AND A.ProductCategory like '%TOURS%'
                                    AND B.Status = 'ACTIVE'
                                    ORDER BY A.CountryName");
                while ($demb1 = mysql_fetch_array($qemb1)) {
                    if ($r[DoaId04] == $demb1[Id]) {
                        echo "<option value='$demb1[Id]' selected>$demb1[Type] - $demb1[Name] - $demb1[Process] - $demb1[IsAdult]</option>";
                    } else {
                        echo "<option value='$demb1[Id]'>$demb1[Type] - $demb1[Name] - $demb1[Process] - $demb1[IsAdult]</option>";
                    }
                }
                echo "</select></td><td> <input type='hidden' name='visanett4' size='12' value='$r[VisaNett4]'>
          <input type='text' name='visasell4' id='visasell4' value='$sellvisa' size='12' $readsell4></td></tr>";
            }
            if ($r[Embassy05] <> '0') {
                $qvisadoa = mysql_query("SELECT SellingValueInRupiah FROM doa_product_price WHERE Id = '$r[DoaId05]' ");
                $dvisadoa = mysql_fetch_array($qvisadoa);
                if ($r[DoaId05] == '0') {
                    $sellvisa = $r[VisaSell5];
                    $readsell5 = '';
                } else {
                    $sellvisa = $dvisadoa[SellingValueInRupiah];
                    $readsell5 = 'readonly';
                }
                echo "<tr><td>Visa $r[Embassy05]</td><td colspan='3'> <select name='visaemb05' id='visaemb05' onChange='PriceVisa5()'>
            <option value='0' selected>- Type -</option>";
                $qemb1 = mysql_query("SELECT B.*,C.Name FROM doa_product A
                                    INNER JOIN doa_product_price B on B.DoaProductId = A.Id
                                    INNER JOIN doa_product_price_category C on C.Id = B.DoaProductPriceCategoryId
                                    where A.ProductType='VISA' AND A.CountryName='$r[Embassy05]' 
                                    AND A.ProductCategory like '%TOURS%'
                                    AND B.Status = 'ACTIVE'
                                    ORDER BY A.CountryName");
                while ($demb1 = mysql_fetch_array($qemb1)) {
                    if ($r[DoaId05] == $demb1[Id]) {
                        echo "<option value='$demb1[Id]' selected>$demb1[Type] - $demb1[Name] - $demb1[Process] - $demb1[IsAdult]</option>";
                    } else {
                        echo "<option value='$demb1[Id]'>$demb1[Type] - $demb1[Name] - $demb1[Process] - $demb1[IsAdult]</option>";
                    }
                }
                echo "</select></td><td> <input type='hidden' name='visanett5' size='12' value='$r[VisaNett5]'>
          <input type='text' name='visasell5' id='visasell5' value='$sellvisa' size='12' $readsell5></td></tr>";
            }
        }else{
            if ($r[Embassy01] <> '0') {
          ...
          <td><input type=text name='visasell' size='12'";
                ...
                echo " value='$r[VisaSell]'onkeyup='isNumber(this)'><input type='hidden' name='visaemb01' value='0'></td></tr>";
            }
            if ($r[Embassy02] <> '0') {
          ...
          <td><input type=text name='visasell2' size='12'";
                ...
                echo " value='$r[VisaSell2]'onkeyup='isNumber(this)'><input type='hidden' name='visaemb02' value='0'></td></tr>";
            }
            if ($r[Embassy03] <> '0') {
              ...
              <td><input type=text name='visasell3' size='12'";
                ...
                echo " value='$r[VisaSell3]'onkeyup='isNumber(this)'><input type='hidden' name='visaemb03' value='0'></td></tr>";
            }
            if ($r[Embassy04] <> '0') {
              ...
              <td><input type=text name='visasell4' size='12'";
                ...
                echo " value='$r[VisaSell4]'onkeyup='isNumber(this)'><input type='hidden' name='visaemb04' value='0'></td></tr>";
            }
            if ($r[Embassy05] <> '0') {
              ...
              <td><input type=text name='visasell5' size='12'";
                ...
                echo " value='$r[VisaSell5]'onkeyup='isNumber(this)'><input type='hidden' name='visaemb05' value='0'></td></tr>";
            }
        }
