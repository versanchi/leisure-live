...
<script type="text/javascript" src="../../head/jquery-1.12.1.js"></script>
...
switch($_GET['act']) {
    ...
    case "tambahmsproduct":
        ...
        echo "' name='datetravelto' size='10' onfocus='selisih()' onClick=" . "cal.select(document.forms['example'].datetravelto,'anchor2','dd-MM-yyyy'); return false;" . " NAME='anchor2' ID='anchor2'>
           ...
           <tr><td>Date</td><td>
            <input type='text' name='departure' id='departure' data-date-range-end='#arrival' placeholder='departure date' readonly><input type='hidden' id='departuretxt' readonly>
            until
            <input type='text' name='arrival' id='arrival' data-date-range-start='#departure' placeholder='arrival date' readonly><input type='hidden' id='arrivaltxt' readonly>
            </td>
            </tr>
    ...
    case "editmsproduct":
        ...
        echo ">&nbsp;Not Required
          ...
          <tr><td></td><td><select name='embassy01' onChange='showDay(1)' $bisa>
            <option value='0' selected>- Embassy 01 -</option>";
        $tampil = mysql_query("SELECT CountryName FROM doa_product where Status = '1' AND ProductType='VISA' GROUP BY CountryName ORDER BY CountryName");
        while ($s = mysql_fetch_array($tampil)) {
