   ...
   default:
    ...
    echo "</select> &nbsp&nbsp
	 Type : <select name='Type' >";
			...
			if($type==Grp){echo"<option value='Grp' selected>Group</option>";}else{echo"<option value='Grp' >Group</option>";}
	...
	if($Dep=='LEISURE'){$TableTarget="tour_mstargetpo";};
	if($Dep=='MINISTRY'){$TableTarget="tour_mstargetpoPMT";};
	if($Dep=='TUR EZ'){$TableTarget="tour_mstargetpotez";};
	if($Dep=='TMR'){$TableTarget="tour_mstargetpotmr";};
  ...
  //munculin table
	...
	while ($DPax = mysql_fetch_array($strQuerytable)) {
				...
				echo "<tr> <td>$No</td>
					 ...
					 <td style='text-align:right'>".number_format($DTarget[JAN], 0, ',', '.');
					 ...
					 echo"</td><td style='text-align:right'>".number_format($DPax[JanNow]/$DTarget[JAN]*100, 0, ',', '.');
					 echo"%</td>
					 					 
					 <td style='text-align:right'>".number_format($DTarget[FEB], 0, ',', '.');
					 ...
					 echo"</td><td style='text-align:right'>".number_format($DPax[FebNow]/$DTarget[FEB]*100, 0, ',', '.');echo"%</td>
					 
					 <td style='text-align:right'>".number_format($DTarget[MAR], 0, ',', '.');
					 ...
					 echo"</td><td style='text-align:right'>".number_format($DPax[MarNow]/$DTarget[MAR]*100, 0, ',', '.');echo"%</td>
					 
					 <td style='text-align:right'>".number_format($DTarget[APR], 0, ',', '.');
					 ...
					 echo"</td><td style='text-align:right'>".number_format($DPax[AprNow]/$DTarget[APR]*100, 0, ',', '.');echo"%</td>
					 
					 <td style='text-align:right'>".number_format($DTarget[MAY], 0, ',', '.');
					 ...
					 echo"</td><td style='text-align:right'>".number_format($DPax[MayNow]/$DTarget[MAY]*100, 0, ',', '.');echo"%</td>
					 
					 <td style='text-align:right'>".number_format($DTarget[JUN], 0, ',', '.');
					 ...
					 echo"</td><td style='text-align:right'>".number_format($DPax[JunNow]/$DTarget[JUN]*100, 0, ',', '.');echo"%</td>
					 
					 <td style='text-align:right'>".number_format($DTarget[JUL], 0, ',', '.');
					 ...
					 echo"</td><td style='text-align:right'>".number_format($DPax[JulNow]/$DTarget[JUL]*100, 0, ',', '.');echo"%</td>
					 
					 <td style='text-align:right'>".number_format($DTarget[AUG], 0, ',', '.');
					 ...
					 echo"</td><td style='text-align:right'>".number_format($DPax[AgtNow]/$DTarget[AUG]*100, 0, ',', '.');echo"%</td>
					 
					 <td style='text-align:right'>".number_format($DTarget[SEP], 0, ',', '.');
					 ...
					 echo"</td><td style='text-align:right'>".number_format($DPax[SepNow]/$DTarget[SEP]*100, 0, ',', '.');echo"%</td>
					 
					 <td style='text-align:right'>".number_format($DTarget[OCT], 0, ',', '.');
					 ...
					 echo"</td><td style='text-align:right'>".number_format($DPax[OctNow]/$DTarget[OCT]*100, 0, ',', '.');echo"%</td>

					 <td style='text-align:right'>".number_format($DTarget[NOV], 0, ',', '.');
					 ...
					 echo"</td><td style='text-align:right'>".number_format($DPax[NovNow]/$DTarget[NOV]*100, 0, ',', '.');echo"%</td>

					 <td style='text-align:right'>".number_format($DTarget[DES], 0, ',', '.');
					 ...
					 echo"</td><td style='text-align:right'>".number_format($DPax[DecNow]/$DTarget[DES]*100, 0, ',', '.');echo"%</td>";
				 ...
				 $TotalLast=$DPax[JanLast]+$DPax[FebLast]+$DPax[MarLast]+$DPax[AprLast]+$DPax[MayLast]+$DPax[JunLast]+$DPax[JulLast]+$DPax[AgtLast]+$DPax[SepLast]+$DPax[OctLast]+$DPax[NovLast]+$DPax[DecLast];
					$TotalTarget=$DTarget[JAN]+$DTarget[FEB]+$DTarget[MAR]+$DTarget[APR]+$DTarget[MAY]+$DTarget[JUN]+$DTarget[JUL]+$DTarget[AUG]+$DTarget[SEP]+
					$DTarget[OCT]+$DTarget[NOV]+$DTarget[DES];
					 ...
					 if ($TotalNow<$TotalLast){$warnaminus="COLOR:Red;";}else{$warnaminus="COLOR:black";}	
...
echo "<tr><td colspan=2 style='background-color: #000000; color:#FFFFFF'><center><b>TOTAL</b></center></td>
				 ...
				 $GrandTotalLast=$GrandJanLast+$GrandFebLast+$GrandMarLast+$GrandAprLast+$GrandMayLast+$GrandJunLast+$GrandJulLast+$GrandAgtLast+$GrandSepLast+$GrandOctLast+$GrandNovLast+$GrandDecLast;
					 ...
					 if ($GrandTotalNow<$GrandTotalLast){$warnaminus="COLOR:Red;";}else{$warnaminus="COLOR:black";}		
					 echo"</td><td style='text-align:right;$warnaminus;background-color: #000000; color:#FFFFFF'>".number_format($GrandTotalNow/$GrandTotalLast*100, 0, ',', '.');echo"%</td></tr>";
	...
	<input type=hidden name=type value='$type'>
	 Base on : <select name='TDetail' >
	 		<option value='ProductCode'";if($TDetail=='ProductCode'){echo"selected";}echo">Product Code</option>
      		<option value='TCName'";if($TDetail=='TCName'){echo"selected";}echo">TC Name</option>
			<option value='POS'";if($TDetail=='POS'){echo"selected";}echo">Division</option>
        </select>
...
echo" <div class='outerbox'>
	...
	$Department='awal';
		while($DPax = mysql_fetch_array($strQuerytable)){
					 ...
					 echo"</td><td style='text-align:right'>".number_format($TotalFebDepartNow/$TotalFebDepartLast*100, 0, ',', '.');echo"%</td>
					 ...
					 echo"</td><td style='text-align:right'>".number_format($TotalMarDepartNow/$TotalMarDepartLast*100, 0, ',', '.');echo"%</td>
					 ...
					 echo"</td><td style='text-align:right'>".number_format($TotalAprDepartNow/$TotalAprDepartLast*100, 0, ',', '.');echo"%</td>
					 ...
					 echo"</td><td style='text-align:right'>".number_format($TotalMayDepartNow/$TotalMayDepartLast*100, 0, ',', '.');echo"%</td>
					 ...
					 echo"</td><td style='text-align:right'>".number_format($TotalJunDepartNow/$TotalJunDepartLast*100, 0, ',', '.');echo"%</td>
					 ...
					 echo"</td><td style='text-align:right'>".number_format($TotalJulDepartNow/$TotalJulDepartLast*100, 0, ',', '.');echo"%</td>
					 ...
					 echo"</td><td style='text-align:right'>".number_format($TotalAgtDepartNow/$TotalAgtDepartLast*100, 0, ',', '.');echo"%</td>
					 ...
					 echo"</td><td style='text-align:right'>".number_format($TotalSepDepartNow/$TotalSepDepartLast*100, 0, ',', '.');echo"%</td>
					 ...
					 echo"</td><td style='text-align:right'>".number_format($TotalOctDepartNow/$TotalOctDepartLast*100, 0, ',', '.');echo"%</td>
					 ...
					 echo"</td><td style='text-align:right'>".number_format($TotalNovDepartNow/$TotalNovDepartLast*100, 0, ',', '.');echo"%</td>
					 ...
					 echo"</td><td style='text-align:right'>".number_format($TotalDecDepartNow/$TotalDecDepartLast*100, 0, ',', '.');echo"%</td>";
				 ...
				 $TotalDepartLast=$TotalJanDepartLast+$TotalFebDepartLast+$TotalMarDepartLast+$TotalAprDepartLast+$TotalMayDepartLast+$TotalJunDepartLast+$TotalJulDepartLast+$TotalAgtDepartLast+$TotalSepDepartLast+$TotalOctDepartLast+$TotalNovDepartLast+$TotalDecDepartLast;
					 ...
					 if ($GrandTotalNow<$GrandTotalLast){$warnaminus="COLOR:Red;";}else{$warnaminus="COLOR:black";}		
					 echo"</td><td style='text-align:right;$warnaminus'>".number_format($TotalDepartNow/$TotalDepartLast*100, 0, ',', '.');echo"%</td></tr><tr><th colspan=42> </th></tr>";
