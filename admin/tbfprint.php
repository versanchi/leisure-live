...
switch($_GET[act]) {                 //  <img src='images/pano1.jpg'>
    default:
        ...
        echo " <form name='example' method='POST' action='$lnk' > 
          <table style='border: 0px solid #000000;'>
          <tr><th BGCOLOR='#f48221'>No</th><th BGCOLOR='#f48221' width=200>PAX Name</th><th BGCOLOR='#f48221' width=40>Type</th><th BGCOLOR='#f48221' width=70>Passport</th><th BGCOLOR='#f48221'>Package</th><th BGCOLOR='#f48221'>$rtype</th><th BGCOLOR='#f48221' width=290>Special request</th></tr>";
        $no = $posisi + 1;
        ...
        if ($r[TBFNo] <> '') {
            ...
            if ($totalseluruh < 1) {
                ...
                echo "<input type='submit' value='CREATE TBF' onClick='return ngecek($paxok,$_GET[code])'>";
    ...
    case "revisetbf":
        ...
        if ($dapet <> 0) {
            mysql_query("UPDATE tour_msbooking SET TBFNo = '$notbf.$revno'
                               WHERE BookingID = '$_POST[getcode]'");
            mysql_query("UPDATE tour_tbfbooking SET TBFRevNo = '$revno',Status='ACTIVE'
