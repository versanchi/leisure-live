...
switch($_GET[act]){
  ...
  default:
    ...
    echo "<table class='bordered' id='fixed_hdr2'>
            <thead>
            <tr><th>PAX : <input type=text name='paxa' size='3' value='$totfix[PaxA]'></th><th></th><th></th>";
    if($r[GroupType]=='CRUISE'){
        echo "<th colspan=4>adult</th><th colspan=4>Child </th></tr></thead>
            <tr><td style='color: #FFFFFF;font-size: 7pt;text-transform: uppercase;text-align: center;background-color: #000000;'></td><td style='color: #FFFFFF;font-size: 7pt;text-transform: uppercase;text-align: center;background-color: #000000;'></td><td style='color: #FFFFFF;font-size: 7pt;text-transform: uppercase;text-align: center;background-color: #000000;'>quotation</td><td colspan=2 style='color: #FFFFFF;font-size: 7pt;text-transform: uppercase;text-align: center;background-color: #000000;'>1-2 PAX</td><td colspan=2>3-4 PAX</td><td colspan=2 style='color: #FFFFFF;font-size: 7pt;text-transform: uppercase;text-align: center;background-color: #000000;'>1-2 PAX</td><td colspan=2 style='color: #FFFFFF;font-size: 7pt;text-transform: uppercase;text-align: center;background-color: #000000;'>3-4 PAX </td></tr>";
    }else{
        echo "<th colspan=2>adult</th><th colspan=6>Child </th></tr></thead>
            <tr><td style='color: #FFFFFF;font-size: 7pt;text-transform: uppercase;text-align: center;background-color: #000000;'></td><td style='color: #FFFFFF;font-size: 7pt;text-transform: uppercase;text-align: center;background-color: #000000;'></td><td style='color: #FFFFFF;font-size: 7pt;text-transform: uppercase;text-align: center;background-color: #000000;'>quotation</td><td colspan=2 style='color: #FFFFFF;font-size: 7pt;text-transform: uppercase;text-align: center;background-color: #000000;'></td><td colspan=2 style='color: #FFFFFF;font-size: 7pt;text-transform: uppercase;text-align: center;background-color: #000000;'>Twin BED</td><td colspan=2 style='color: #FFFFFF;font-size: 7pt;text-transform: uppercase;text-align: center;background-color: #000000;'>Extra BED </td><td colspan=2 style='color: #FFFFFF;font-size: 7pt;text-transform: uppercase;text-align: center;background-color: #000000;'>NO BED </td></tr>";
    }
    echo "<tr><td style='color: #FFFFFF;font-size: 7pt;text-transform: uppercase;text-align: center;background-color: #000000;'><b>supplier</b></td><td style='color: #FFFFFF;font-size: 7pt;text-transform: uppercase;text-align: center;background-color: #000000;'>description</td><td style='color: #FFFFFF;font-size: 7pt;text-transform: uppercase;text-align: center;background-color: #000000;'>Curr - Operator - Rate</td><td style='color: #FFFFFF;font-size: 7pt;text-transform: uppercase;text-align: center;background-color: #000000;'></td><td style='color: #FFFFFF;font-size: 7pt;text-transform: uppercase;text-align: center;background-color: #000000;'>In $r[SellingCurr]</td><td style='color: #FFFFFF;font-size: 7pt;text-transform: uppercase;text-align: center;background-color: #000000;'></td><td style='color: #FFFFFF;font-size: 7pt;text-transform: uppercase;text-align: center;background-color: #000000;'>In $r[SellingCurr]</td><td style='color: #FFFFFF;font-size: 7pt;text-transform: uppercase;text-align: center;background-color: #000000;'></td><td style='color: #FFFFFF;font-size: 7pt;text-transform: uppercase;text-align: center;background-color: #000000;'>In $r[SellingCurr]</td><td style='color: #FFFFFF;font-size: 7pt;text-transform: uppercase;text-align: center;background-color: #000000;'></td><td style='color: #FFFFFF;font-size: 7pt;text-transform: uppercase;text-align: center;background-color: #000000;'>In $r[SellingCurr]</td></tr>
            <tbody>
               ...
               echo "</select></td><td><input type=text name='desc1' size='25' value='$fix1[Description]'></td>
                    ...
                    while($s=mysql_fetch_array($tampil)){
                        if($fix1[QuotationCurrA]==''){$fca1='IDR';}else{$fca1=$fix1[QuotationCurrA];}
                        if($s[curr]==$fca1){
                    ...
                    echo "</select><input type='hidden' name='sellingoperator1' size='3' value='$fix1[SellingOperatorA]' ><br>
                                <input type='text' style='border: hidden;text-align:center;' name='sellingrate1' size='6' value='$fix1[SellingRateA]' readonly>
               ...
               echo "</select></td><td><input type=text name='desc2' size='25' value='$fix2[Description]'></td>
                    ...
                    $tampil=mysql_query("SELECT * FROM cim_rate ORDER BY RateID");
                    while($s=mysql_fetch_array($tampil)){
                        if($fix2[QuotationCurrA]==''){$fca2='IDR';}else{$fca2=$fix2[QuotationCurrA];}
                        if($s[curr]==$fca2){
                            echo "<option value='$s[curr]' selected>$s[curr]</option>";
                        } else {
                            echo "<option value='$s[curr]' >$s[curr]</option>";
                    ...
                    echo "</select><input type='hidden' name='sellingoperator2' size='3' value='$fix2[SellingOperatorA]' ><br>
                                <input type='text' style='border: hidden;text-align:center;' name='sellingrate2' size='6' value='$fix2[SellingRateA]' readonly>
               ...
               echo "</select></td><td><input type=text name='desc3' size='25' value='$fix3[Description]'></td>
                    ...
                    $tampil=mysql_query("SELECT * FROM cim_rate ORDER BY RateID");
                    while($s=mysql_fetch_array($tampil)){
                        if($fix3[QuotationCurrA]==''){$fca3='IDR';}else{$fca3=$fix3[QuotationCurrA];}
                        if($s[curr]==$fca3){
                            echo "<option value='$s[curr]' selected>$s[curr]</option>";
                        } else {
                            echo "<option value='$s[curr]' >$s[curr]</option>";
                    ...
                    echo "</select><input type='hidden' name='sellingoperator3' size='3' value='$fix3[SellingOperatorA]' ><br>
                                <input type='text' style='border: hidden;text-align:center;' name='sellingrate3' size='6' value='$fix3[SellingRateA]' readonly>
               ...
               echo "</select></td><td><input type=text name='desc4' size='25' value='$fix4[Description]'></td>
                    ...
                    $tampil=mysql_query("SELECT * FROM cim_rate ORDER BY RateID");
                    while($s=mysql_fetch_array($tampil)){
                        if($fix4[QuotationCurrA]==''){$fca4='IDR';}else{$fca4=$fix4[QuotationCurrA];}
                        if($s[curr]==$fca4){
                            echo "<option value='$s[curr]' selected>$s[curr]</option>";
                        } else {
                            echo "<option value='$s[curr]' >$s[curr]</option>";
                    ...
                    echo "</select><input type='hidden' name='sellingoperator4' size='3' value='$fix4[SellingOperatorA]' ><br>
                                <input type='text' style='border: hidden;text-align:center;' name='sellingrate4' size='6' value='$fix4[SellingRateA]' readonly>
               ...
               echo "</select></td><td><input type=text name='desc5' size='25' value='$fix5[Description]'></td>
                    ...
                    $tampil=mysql_query("SELECT * FROM cim_rate ORDER BY RateID");
                    while($s=mysql_fetch_array($tampil)){
                        if($fix5[QuotationCurrA]==''){$fca5='IDR';}else{$fca5=$fix5[QuotationCurrA];}
                        if($s[curr]==$fca5){
                            echo "<option value='$s[curr]' selected>$s[curr]</option>";
                        } else {
                            echo "<option value='$s[curr]' >$s[curr]</option>";
                    ...
                    echo "</select><input type='hidden' name='sellingoperator5' size='3' value='$fix5[SellingOperatorA]' ><br>
                                <input type='text' style='border: hidden;text-align:center;' name='sellingrate5' size='6' value='$fix5[SellingRateA]' readonly>
               ...
               echo "</select></td><td><input type=text name='desc6' size='25' value='$fix6[Description]'></td>
                    ...
                    $tampil=mysql_query("SELECT * FROM cim_rate ORDER BY RateID");
                    while($s=mysql_fetch_array($tampil)){
                        if($fix6[QuotationCurrA]==''){$fca6='IDR';}else{$fca6=$fix6[QuotationCurrA];}
                        if($s[curr]==$fca6){
                            echo "<option value='$s[curr]' selected>$s[curr]</option>";
                        } else {
                            echo "<option value='$s[curr]' >$s[curr]</option>";
                    ...
                    echo "</select><input type='hidden' name='sellingoperator6' size='3' value='$fix6[SellingOperatorA]' ><br>
                                <input type='text' style='border: hidden;text-align:center;' name='sellingrate6' size='6' value='$fix6[SellingRateA]' readonly>
               ...
               echo "</select></td><td><input type=text name='desc7' size='25' value='$fix7[Description]'></td>
                    ...
                    $tampil=mysql_query("SELECT * FROM cim_rate ORDER BY RateID");
                    while($s=mysql_fetch_array($tampil)){
                        if($fix7[QuotationCurrA]==''){$fca7='IDR';}else{$fca7=$fix7[QuotationCurrA];}
                        if($s[curr]==$fca7){
                            echo "<option value='$s[curr]' selected>$s[curr]</option>";
                        } else {
                            echo "<option value='$s[curr]' >$s[curr]</option>";
                    ...
                    echo "</select><input type='hidden' name='sellingoperator7' size='3' value='$fix7[SellingOperatorA]' ><br>
                                <input type='text' style='border: hidden;text-align:center;' name='sellingrate7' size='6' value='$fix7[SellingRateA]' readonly>
               ...
               echo "</select></td><td><input type=text name='desc8' size='25' value='$fix8[Description]'></td>
                    ...
                    $tampil=mysql_query("SELECT * FROM cim_rate ORDER BY RateID");
                    while($s=mysql_fetch_array($tampil)){
                        if($fix8[QuotationCurrA]==''){$fca8='IDR';}else{$fca8=$fix8[QuotationCurrA];}
                        if($s[curr]==$fca8){
                            echo "<option value='$s[curr]' selected>$s[curr]</option>";
                        } else {
                            echo "<option value='$s[curr]' >$s[curr]</option>";
                    ...
                    echo "</select><input type='hidden' name='sellingoperator8' size='3' value='$fix8[SellingOperatorA]' ><br>
                                <input type='text' style='border: hidden;text-align:center;' name='sellingrate8' size='6' value='$fix8[SellingRateA]' readonly>
               ...
               echo "</select></td><td><input type=text name='desc9' size='25' value='$fix9[Description]'></td>
                    ...
                    $tampil=mysql_query("SELECT * FROM cim_rate ORDER BY RateID");
                    while($s=mysql_fetch_array($tampil)){
                        if($fix9[QuotationCurrA]==''){$fca9='IDR';}else{$fca9=$fix9[QuotationCurrA];}
                        if($s[curr]==$fca9){
                            echo "<option value='$s[curr]' selected>$s[curr]</option>";
                        } else {
                            echo "<option value='$s[curr]' >$s[curr]</option>";
                    ...
                    echo "</select><input type='hidden' name='sellingoperator9' size='3' value='$fix9[SellingOperatorA]' ><br>
                                <input type='text' style='border: hidden;text-align:center;' name='sellingrate9' size='6' value='$fix9[SellingRateA]' readonly>
               ...
               echo "</select></td><td><input type=text name='desc10' size='25' value='$fix10[Description]'></td>
                    ...
                    $tampil=mysql_query("SELECT * FROM cim_rate ORDER BY RateID");
                    while($s=mysql_fetch_array($tampil)){
                        if($fix10[QuotationCurrA]==''){$fca10='IDR';}else{$fca10=$fix10[QuotationCurrA];}
                        if($s[curr]==$fca10){
                            echo "<option value='$s[curr]' selected>$s[curr]</option>";
                        } else {
                            echo "<option value='$s[curr]' >$s[curr]</option>";
                    ...
                    echo "</select><input type='hidden' name='sellingoperator10' size='3' value='$fix10[SellingOperatorA]' ><br>
                                <input type='text' style='border: hidden;text-align:center;' name='sellingrate10' size='6' value='$fix10[SellingRateA]' readonly>
...
$edit=mysql_query("SELECT * FROM tour_msproduct WHERE IDProduct = '$_GET[id]'");
    ...
    echo "<h2>AGENT COST (OPTION B) - $r[TourCode]</h2>    
          ...
          <input type='hidden' name='sellingcurr' value='$r[SellingCurr]'>";
            ...
            $isitotal=mysql_query("SELECT * FROM tour_msdetail
                                where IDProduct = '$r[IDProduct]' ");
            $totfix=mysql_fetch_array($isitotal);
            if($fix1[QuotationCurrB]==$r[SellingCurr]){$ok1='disabled';}else{$ok1='enabled';}
            if($fix2[QuotationCurrB]==$r[SellingCurr]){$ok2='disabled';}else{$ok2='enabled';}
            if($fix3[QuotationCurrB]==$r[SellingCurr]){$ok3='disabled';}else{$ok3='enabled';}
            if($fix4[QuotationCurrB]==$r[SellingCurr]){$ok4='disabled';}else{$ok4='enabled';}
            if($fix5[QuotationCurrB]==$r[SellingCurr]){$ok5='disabled';}else{$ok5='enabled';}
            if($fix6[QuotationCurrB]==$r[SellingCurr]){$ok6='disabled';}else{$ok6='enabled';}
            if($fix7[QuotationCurrB]==$r[SellingCurr]){$ok7='disabled';}else{$ok7='enabled';}
            if($fix8[QuotationCurrB]==$r[SellingCurr]){$ok8='disabled';}else{$ok8='enabled';}
            if($fix9[QuotationCurrB]==$r[SellingCurr]){$ok9='disabled';}else{$ok9='enabled';}
            if($fix10[QuotationCurrB]==$r[SellingCurr]){$ok10='disabled';}else{$ok10='enabled';}
    echo "<table>
              <tr><th>PAX : <input type=text name='paxb' size='3' value='$totfix[PaxB]'></th><th></th><th></th>";
    if($r[GroupType]=='CRUISE'){
        echo "<th colspan=4>adult</th><th colspan=4>Child </th></tr>
              <tr><th></th><th></th><th>quotation</th><th colspan=2>1-2 PAX</th><th colspan=2>3-4 PAX</th><th colspan=2>1-2 PAX</th><th colspan=2>3-4 PAX </th></tr>";
    }else{
        echo "<th colspan=2>adult</th><th colspan=6>Child </th></tr>
              <tr><th></th><th></th><th>quotation</th><th colspan=2></th><th colspan=2>Twin BED</th><th colspan=2>Extra BED </th><th colspan=2>NO BED </th></tr>";
    }
    echo "<tr><th>supplier</th><th>description</th><th width='600'>Curr - Operator - Rate</th><th></th><th>In $r[SellingCurr]</th><th></th><th>In $r[SellingCurr]</th><th></th><th>In $r[SellingCurr]</th><th></th><th>In $r[SellingCurr]</th></tr>
    ...
    $tampil=mysql_query("SELECT * FROM cim_rate ORDER BY RateID");
    while($s=mysql_fetch_array($tampil)){
        if($fix1[QuotationCurrB]==''){$fcb1='IDR';}else{$fcb1=$fix1[QuotationCurrB];}
        if($s[curr]==$fcb1){
            echo "<option value='$s[curr]' selected>$s[curr]</option>";
        } else {
            echo "<option value='$s[curr]' >$s[curr]</option>";
    ...
    echo "</select><input type='hidden' name='sellingoperator1' size='3' value='$fix1[SellingOperatorB]' ><br>
                                <input type='text' style='border: hidden;text-align:center;' name='sellingrate1' size='6' value='$fix1[SellingRateB]' readonly>
    ...
    $tampil=mysql_query("SELECT * FROM cim_rate ORDER BY RateID");
    while($s=mysql_fetch_array($tampil)){
        if($fix2[QuotationCurrB]==''){$fcb2='IDR';}else{$fcb2=$fix2[QuotationCurrB];}
        if($s[curr]==$fcb2){
            echo "<option value='$s[curr]' selected>$s[curr]</option>";
        } else {
            echo "<option value='$s[curr]' >$s[curr]</option>";
    ...
    echo "</select><input type='hidden' name='sellingoperator2' size='3' value='$fix2[SellingOperatorB]' ><br>
                                <input type='text' style='border: hidden;text-align:center;' name='sellingrate2' size='6' value='$fix2[SellingRateB]' readonly>
    ...
    $tampil=mysql_query("SELECT * FROM cim_rate ORDER BY RateID");
    while($s=mysql_fetch_array($tampil)){
        if($fix3[QuotationCurrB]==''){$fcb3='IDR';}else{$fcb3=$fix3[QuotationCurrB];}
        if($s[curr]==$fcb3){
            echo "<option value='$s[curr]' selected>$s[curr]</option>";
        } else {
            echo "<option value='$s[curr]' >$s[curr]</option>";
    ...
    echo "</select><input type='hidden' name='sellingoperator3' size='3' value='$fix3[SellingOperatorB]' ><br>
                                <input type='text' style='border: hidden;text-align:center;' name='sellingrate3' size='6' value='$fix3[SellingRateB]' readonly>
    ...
    $tampil=mysql_query("SELECT * FROM cim_rate ORDER BY RateID");
    while($s=mysql_fetch_array($tampil)){
        if($fix4[QuotationCurrB]==''){$fcb4='IDR';}else{$fcb4=$fix4[QuotationCurrB];}
        if($s[curr]==$fcb4){
            echo "<option value='$s[curr]' selected>$s[curr]</option>";
        } else {
            echo "<option value='$s[curr]' >$s[curr]</option>";
    ...
    echo "</select><input type='hidden' name='sellingoperator4' size='3' value='$fix4[SellingOperatorB]' ><br>
                                <input type='text' style='border: hidden;text-align:center;' name='sellingrate4' size='6' value='$fix4[SellingRateB]' readonly>
    ...
    $tampil=mysql_query("SELECT * FROM cim_rate ORDER BY RateID");
    while($s=mysql_fetch_array($tampil)){
        if($fix5[QuotationCurrB]==''){$fcb5='IDR';}else{$fcb5=$fix5[QuotationCurrB];}
        if($s[curr]==$fcb5){
            echo "<option value='$s[curr]' selected>$s[curr]</option>";
        } else {
            echo "<option value='$s[curr]' >$s[curr]</option>";
    ...
    echo "</select><input type='hidden' name='sellingoperator5' size='3' value='$fix5[SellingOperatorB]' ><br>
                                <input type='text' style='border: hidden;text-align:center;' name='sellingrate5' size='6' value='$fix5[SellingRateB]' readonly>
    ...
    $tampil=mysql_query("SELECT * FROM cim_rate ORDER BY RateID");
    while($s=mysql_fetch_array($tampil)){
        if($fix6[QuotationCurrB]==''){$fcb6='IDR';}else{$fcb6=$fix6[QuotationCurrB];}
        if($s[curr]==$fcb6){
            echo "<option value='$s[curr]' selected>$s[curr]</option>";
        } else {
            echo "<option value='$s[curr]' >$s[curr]</option>";
    ...
    echo "</select><input type='hidden' name='sellingoperator6' size='3' value='$fix6[SellingOperatorB]' ><br>
                                <input type='text' style='border: hidden;text-align:center;' name='sellingrate6' size='6' value='$fix6[SellingRateB]' readonly>
    ...
    $tampil=mysql_query("SELECT * FROM cim_rate ORDER BY RateID");
    while($s=mysql_fetch_array($tampil)){
        if($fix7[QuotationCurrB]==''){$fcb7='IDR';}else{$fcb7=$fix7[QuotationCurrB];}
        if($s[curr]==$fcb7){
            echo "<option value='$s[curr]' selected>$s[curr]</option>";
        } else {
            echo "<option value='$s[curr]' >$s[curr]</option>";
    ...
    echo "</select><input type='hidden' name='sellingoperator7' size='3' value='$fix7[SellingOperatorB]' ><br>
                                <input type='text' style='border: hidden;text-align:center;' name='sellingrate7' size='6' value='$fix7[SellingRateB]' readonly>
    ...
    $tampil=mysql_query("SELECT * FROM cim_rate ORDER BY RateID");
    while($s=mysql_fetch_array($tampil)){
        if($fix8[QuotationCurrB]==''){$fcb8='IDR';}else{$fcb8=$fix8[QuotationCurrB];}
        if($s[curr]==$fcb8){
            echo "<option value='$s[curr]' selected>$s[curr]</option>";
        } else {
            echo "<option value='$s[curr]' >$s[curr]</option>";
    ...
    echo "</select><input type='hidden' name='sellingoperator8' size='3' value='$fix8[SellingOperatorB]' ><br>
                                <input type='text' style='border: hidden;text-align:center;' name='sellingrate8' size='6' value='$fix8[SellingRateB]' readonly>
    ...
    $tampil=mysql_query("SELECT * FROM cim_rate ORDER BY RateID");
    while($s=mysql_fetch_array($tampil)){
        if($fix9[QuotationCurrB]==''){$fcb9='IDR';}else{$fcb9=$fix9[QuotationCurrB];}
        if($s[curr]==$fcb9){
            echo "<option value='$s[curr]' selected>$s[curr]</option>";
        } else {
            echo "<option value='$s[curr]' >$s[curr]</option>";
    ...
    echo "</select><input type='hidden' name='sellingoperator9' size='3' value='$fix9[SellingOperatorB]' ><br>
                                <input type='text' style='border: hidden;text-align:center;' name='sellingrate9' size='6' value='$fix9[SellingRateB]' readonly>
    ...
    $tampil=mysql_query("SELECT * FROM cim_rate ORDER BY RateID");
    while($s=mysql_fetch_array($tampil)){
        if($fix10[QuotationCurrB]==''){$fcb10='IDR';}else{$fcb10=$fix10[QuotationCurrB];}
        if($s[curr]==$fcb10){
            echo "<option value='$s[curr]' selected>$s[curr]</option>";
        } else {
            echo "<option value='$s[curr]' >$s[curr]</option>";
    ...
    echo "</select><input type='hidden' name='sellingoperator10' size='3' value='$fix10[SellingOperatorB]' ><br>
                                <input type='text' style='border: hidden;text-align:center;' name='sellingrate10' size='6' value='$fix10[SellingRateB]' readonly>
...
$edit=mysql_query("SELECT * FROM tour_msproduct WHERE IDProduct = '$_GET[id]'");
    ...
    echo "<h2>AGENT COST (OPTION C) - $r[TourCode]</h2>    
          ...
          <input type='hidden' name='sellingcurr' value='$r[SellingCurr]'>";
            ...
            $isitotal=mysql_query("SELECT * FROM tour_msdetail
                                where IDProduct = '$r[IDProduct]' ");
            $totfix=mysql_fetch_array($isitotal);
            if($fix1[QuotationCurrC]==$r[SellingCurr]){$ok1='disabled';}else{$ok1='enabled';}
            if($fix2[QuotationCurrC]==$r[SellingCurr]){$ok2='disabled';}else{$ok2='enabled';}
            if($fix3[QuotationCurrC]==$r[SellingCurr]){$ok3='disabled';}else{$ok3='enabled';}
            if($fix4[QuotationCurrC]==$r[SellingCurr]){$ok4='disabled';}else{$ok4='enabled';}
            if($fix5[QuotationCurrC]==$r[SellingCurr]){$ok5='disabled';}else{$ok5='enabled';}
            if($fix6[QuotationCurrC]==$r[SellingCurr]){$ok6='disabled';}else{$ok6='enabled';}
            if($fix7[QuotationCurrC]==$r[SellingCurr]){$ok7='disabled';}else{$ok7='enabled';}
            if($fix8[QuotationCurrC]==$r[SellingCurr]){$ok8='disabled';}else{$ok8='enabled';}
            if($fix9[QuotationCurrC]==$r[SellingCurr]){$ok9='disabled';}else{$ok9='enabled';}
            if($fix10[QuotationCurrC]==$r[SellingCurr]){$ok10='disabled';}else{$ok10='enabled';}
    echo "<table>
                    <tr><th>PAX : <input type=text name='paxc' size='3' value='$totfix[PaxC]'></th><th></th><th></th>";
    if($r[GroupType]=='CRUISE'){
        echo "<th colspan=4>adult</th><th colspan=4>Child </th></tr>
              <tr><th></th><th></th><th>quotation</th><th colspan=2>1-2 PAX</th><th colspan=2>3-4 PAX</th><th colspan=2>1-2 PAX</th><th colspan=2>3-4 PAX </th></tr>";
    }else{
    ...
    $tampil=mysql_query("SELECT * FROM cim_rate ORDER BY RateID");
    while($s=mysql_fetch_array($tampil)){
        if($fix1[QuotationCurrC]==''){$fcc1='IDR';}else{$fcc1=$fix1[QuotationCurrC];}
        if($s[curr]==$fcc1){
            echo "<option value='$s[curr]' selected>$s[curr]</option>";
        } else {
            echo "<option value='$s[curr]' >$s[curr]</option>";
    ...
    echo "</select><input type='hidden' name='sellingoperator1' size='3' value='$fix1[SellingOperatorC]' ><br>
                                <input type='text' style='border: hidden;text-align:center;' name='sellingrate1' size='6' value='$fix1[SellingRateC]' readonly>
    ...
    $tampil=mysql_query("SELECT * FROM cim_rate ORDER BY RateID");
    while($s=mysql_fetch_array($tampil)){
        if($fix2[QuotationCurrC]==''){$fcc2='IDR';}else{$fcc2=$fix2[QuotationCurrC];}
        if($s[curr]==$fcc2){
            echo "<option value='$s[curr]' selected>$s[curr]</option>";
        } else {
            echo "<option value='$s[curr]' >$s[curr]</option>";
    ...
    echo "</select><input type='hidden' name='sellingoperator2' size='3' value='$fix2[SellingOperatorC]' ><br>
                                <input type='text' style='border: hidden;text-align:center;' name='sellingrate2' size='6' value='$fix2[SellingRateC]' readonly>
    ...
    $tampil=mysql_query("SELECT * FROM cim_rate ORDER BY RateID");
    while($s=mysql_fetch_array($tampil)){
        if($fix3[QuotationCurrC]==''){$fcc3='IDR';}else{$fcc3=$fix3[QuotationCurrC];}
        if($s[curr]==$fcc3){
            echo "<option value='$s[curr]' selected>$s[curr]</option>";
        } else {
            echo "<option value='$s[curr]' >$s[curr]</option>";
    ...
    echo "</select><input type='hidden' name='sellingoperator3' size='3' value='$fix3[SellingOperatorC]' ><br>
                                <input type='text' style='border: hidden;text-align:center;' name='sellingrate3' size='6' value='$fix3[SellingRateC]' readonly>
    ...
    $tampil=mysql_query("SELECT * FROM cim_rate ORDER BY RateID");
    while($s=mysql_fetch_array($tampil)){
        if($fix4[QuotationCurrC]==''){$fcc4='IDR';}else{$fcc4=$fix4[QuotationCurrC];}
        if($s[curr]==$fcc4){
            echo "<option value='$s[curr]' selected>$s[curr]</option>";
        } else {
            echo "<option value='$s[curr]' >$s[curr]</option>";
    ...
    echo "</select><input type='hidden' name='sellingoperator4' size='3' value='$fix4[SellingOperatorC]' ><br>
                                <input type='text' style='border: hidden;text-align:center;' name='sellingrate4' size='6' value='$fix4[SellingRateC]' readonly>
    ...
    $tampil=mysql_query("SELECT * FROM cim_rate ORDER BY RateID");
    while($s=mysql_fetch_array($tampil)){
        if($fix5[QuotationCurrC]==''){$fcc5='IDR';}else{$fcc5=$fix5[QuotationCurrC];}
        if($s[curr]==$fcc5){
            echo "<option value='$s[curr]' selected>$s[curr]</option>";
        } else {
            echo "<option value='$s[curr]' >$s[curr]</option>";
    ...
    echo "</select><input type='hidden' name='sellingoperator5' size='3' value='$fix5[SellingOperatorC]' ><br>
                                <input type='text' style='border: hidden;text-align:center;' name='sellingrate5' size='6' value='$fix5[SellingRateC]' readonly>
    ...
    $tampil=mysql_query("SELECT * FROM cim_rate ORDER BY RateID");
    while($s=mysql_fetch_array($tampil)){
        if($fix6[QuotationCurrC]==''){$fcc6='IDR';}else{$fcc6=$fix6[QuotationCurrC];}
        if($s[curr]==$fcc6){
            echo "<option value='$s[curr]' selected>$s[curr]</option>";
        } else {
            echo "<option value='$s[curr]' >$s[curr]</option>";
    ...
    echo "</select><input type='hidden' name='sellingoperator6' size='3' value='$fix6[SellingOperatorC]' ><br>
                                <input type='text' style='border: hidden;text-align:center;' name='sellingrate6' size='6' value='$fix6[SellingRateC]' readonly>
    ...
    $tampil=mysql_query("SELECT * FROM cim_rate ORDER BY RateID");
    while($s=mysql_fetch_array($tampil)){
        if($fix7[QuotationCurrC]==''){$fcc7='IDR';}else{$fcc7=$fix7[QuotationCurrC];}
        if($s[curr]==$fcc7){
            echo "<option value='$s[curr]' selected>$s[curr]</option>";
        } else {
            echo "<option value='$s[curr]' >$s[curr]</option>";
    ...
    echo "</select><input type='hidden' name='sellingoperator7' size='3' value='$fix7[SellingOperatorC]' ><br>
                                <input type='text' style='border: hidden;text-align:center;' name='sellingrate7' size='6' value='$fix7[SellingRateC]' readonly>
    ...
    $tampil=mysql_query("SELECT * FROM cim_rate ORDER BY RateID");
    while($s=mysql_fetch_array($tampil)){
        if($fix8[QuotationCurrC]==''){$fcc8='IDR';}else{$fcc8=$fix8[QuotationCurrC];}
        if($s[curr]==$fcc8){
            echo "<option value='$s[curr]' selected>$s[curr]</option>";
        } else {
            echo "<option value='$s[curr]' >$s[curr]</option>";
    ...
    echo "</select><input type='hidden' name='sellingoperator8' size='3' value='$fix8[SellingOperatorC]' ><br>
                                <input type='text' style='border: hidden;text-align:center;' name='sellingrate8' size='6' value='$fix8[SellingRateC]' readonly>
    ...
    $tampil=mysql_query("SELECT * FROM cim_rate ORDER BY RateID");
    while($s=mysql_fetch_array($tampil)){
        if($fix9[QuotationCurrC]==''){$fcc9='IDR';}else{$fcc9=$fix9[QuotationCurrC];}
        if($s[curr]==$fcc9){
            echo "<option value='$s[curr]' selected>$s[curr]</option>";
        } else {
            echo "<option value='$s[curr]' >$s[curr]</option>";
    ...
    echo "</select><input type='hidden' name='sellingoperator9' size='3' value='$fix9[SellingOperatorC]' ><br>
                                <input type='text' style='border: hidden;text-align:center;' name='sellingrate9' size='6' value='$fix9[SellingRateC]' readonly>
    ...
    $tampil=mysql_query("SELECT * FROM cim_rate ORDER BY RateID");
    while($s=mysql_fetch_array($tampil)){
        if($fix10[QuotationCurrC]==''){$fcc10='IDR';}else{$fcc10=$fix10[QuotationCurrC];}
        if($s[curr]==$fcc10){
            echo "<option value='$s[curr]' selected>$s[curr]</option>";
        } else {
            echo "<option value='$s[curr]' >$s[curr]</option>";
    ...
    echo "</select><input type='hidden' name='sellingoperator10' size='3' value='$fix10[SellingOperatorC]' ><br>
                                <input type='text' style='border: hidden;text-align:center;' name='sellingrate10' size='6' value='$fix10[SellingRateC]' readonly>
