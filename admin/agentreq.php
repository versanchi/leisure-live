...
field.value = field.value.replace(/[^0-9'.']/g,"");
 ...
 function itung(){
    UpdateSellA(1); UpdateSellC(1); UpdateSellD(1); 
    UpdateSellA(2); UpdateSellC(2); UpdateSellD(2);
    UpdateSellA(3); UpdateSellC(3); UpdateSellD(3);
    UpdateSellA(4); UpdateSellC(4); UpdateSellD(4);
    UpdateSellA(5); UpdateSellC(5); UpdateSellD(5);
    UpdateSellA(6); UpdateSellC(6); UpdateSellD(6);
    UpdateSellA(7); UpdateSellC(7); UpdateSellD(7);
    UpdateSellA(8); UpdateSellC(8); UpdateSellD(8);
    UpdateSellA(9); UpdateSellC(9); UpdateSellD(9);
    UpdateSellA(10); UpdateSellC(10); UpdateSellD(10);
...
switch($_GET[act]){
  ...
  default:
    ...
    if($totfix[AliasOptA]==''){$nameopt='OPTION A';}else{$nameopt=$totfix[AliasOptA];}
    $depdate = substr($r[DateTravelFrom],8,2);         
    echo "<form method=POST name='calculate' action='?module=agentreq&act=save'>
          <h2>OPTION NAME : <input type=text name='opta' value='$nameopt' size='80'> - TMR No : $datatmr[TmrNo].$datatmr[TmrOption]</h2>    
          ...
          <input type='hidden' name='sellingcurr' value='$r[SellingCurr]'>";
            ...
            echo "<table>
                    <tr><th>$datatmr[Seat] PAX<input type='hidden' name='paxa' size='3' value='$datatmr[Seat]'></th><th></th><th colspan=2>adult</th><th colspan=4>Child </th></tr>
                    <tr><th></th><th></th><th colspan=2></th><th colspan=2>Twin BED</th><th colspan=2>Extra BED </th></tr>
                    <tr><th>supplier</th><th>description</th><th>In $r[QuotationCurr]</th><th>In $r[SellingCurr]</th><th>In $r[QuotationCurr]</th><th>In $r[SellingCurr]</th><th>In $r[QuotationCurr]</th><th>In $r[SellingCurr]</th></tr> 
               ...
               echo "</select></td><td><input type=text name='desc1' size='30' value='$fix1[Description]'></td>
                     ...
                     <td><input type=text name='quochdx1' size='12' value='$fix1[QuoChdXbedA]'onkeyup='isNumber(this);UpdateSellD(1)'></td><td><input type='text' name='sellchdx1' value='$fix1[SellChdXbedA]' size='12'onkeyup='isNumber(this);TotalD()' ></td></tr>
               ...
               echo "</select></td><td><input type=text name='desc2' size='30' value='$fix2[Description]'></td>
                     ...
                     <td><input type=text name='quochdx2' size='12' value='$fix2[QuoChdXbedA]'onkeyup='isNumber(this);UpdateSellD(2)'></td><td><input type='text' name='sellchdx2' value='$fix2[SellChdXbedA]' size='12'onkeyup='isNumber(this);TotalD()' ></td></tr>
               ...
               echo "</select></td><td><input type=text name='desc3' size='30' value='$fix3[Description]'></td>
                     ...
                     <td><input type=text name='quochdx3' size='12' value='$fix3[QuoChdXbedA]'onkeyup='isNumber(this);UpdateSellD(3)'></td><td><input type='text' name='sellchdx3' value='$fix3[SellChdXbedA]' size='12'onkeyup='isNumber(this);TotalD()' ></td></tr>
               ...
               echo "</select></td><td><input type=text name='desc4' size='30' value='$fix4[Description]'></td>
                     ...
                     <td><input type=text name='quochdx4' size='12' value='$fix4[QuoChdXbedA]'onkeyup='isNumber(this);UpdateSellD(4)'></td><td><input type='text' name='sellchdx4' value='$fix4[SellChdXbedA]' size='12'onkeyup='isNumber(this);TotalD()' ></td></tr>
               ...
               echo "</select></td><td><input type=text name='desc5' size='30' value='$fix5[Description]'></td>
                     ...
                     <td><input type=text name='quochdx5' size='12' value='$fix5[QuoChdXbedA]'onkeyup='isNumber(this);UpdateSellD(5)'></td><td><input type='text' name='sellchdx5' value='$fix5[SellChdXbedA]' size='12'onkeyup='isNumber(this);TotalD()' ></td></tr>
               ...
               echo "</select></td><td><input type=text name='desc6' size='30' value='$fix6[Description]'></td>
                     ...
                     <td><input type=text name='quochdx6' size='12' value='$fix6[QuoChdXbedA]'onkeyup='isNumber(this);UpdateSellD(6)'></td><td><input type='text' name='sellchdx6' value='$fix6[SellChdXbedA]' size='12'onkeyup='isNumber(this);TotalD()' ></td></tr>
               ...
               echo "</select></td><td><input type=text name='desc7' size='30' value='$fix7[Description]'></td>
                     ...
                     <td><input type=text name='quochdx7' size='12' value='$fix7[QuoChdXbedA]'onkeyup='isNumber(this);UpdateSellD(7)'></td><td><input type='text' name='sellchdx7' value='$fix7[SellChdXbedA]' size='12'onkeyup='isNumber(this);TotalD()' ></td></tr>
               ...
               echo "</select></td><td><input type=text name='desc8' size='30' value='$fix8[Description]'></td>
                     ...
                     <td><input type=text name='quochdx8' size='12' value='$fix8[QuoChdXbedA]'onkeyup='isNumber(this);UpdateSellD(8)'></td><td><input type='text' name='sellchdx8' value='$fix8[SellChdXbedA]' size='12'onkeyup='isNumber(this);TotalD()' ></td></tr>
               ...
               echo "</select></td><td><input type=text name='desc9' size='30' value='$fix9[Description]'></td>
                     ...
                     <td><input type=text name='quochdx9' size='12' value='$fix9[QuoChdXbedA]'onkeyup='isNumber(this);UpdateSellD(9)'></td><td><input type='text' name='sellchdx9' value='$fix9[SellChdXbedA]' size='12'onkeyup='isNumber(this);TotalD()' ></td></tr>
               ...
               echo "</select></td><td><input type=text name='desc10' size='30' value='$fix10[Description]'></td>
                     ...
                     <td><input type=text name='quochdx10' size='12' value='$fix10[QuoChdXbedA]'onkeyup='isNumber(this);UpdateSellD(10)'></td><td><input type='text' name='sellchdx10' value='$fix10[SellChdXbedA]' size='12'onkeyup='isNumber(this);TotalD()' ></td></tr>
                    ...
                    <td></td><td><input type='text' name='totalchdxbeda' value='$totfix[TotalChdXbedA]' size='12' style='text-align: left;border: 0px solid #000000;' readonly></td></tr>
                    </table>    
  ...
  case "save":
  $paxa=$_POST[paxa];                   
  $Description="Update Fix Cost TMR ($datatmr[TmrNo].$datatmr[TmrOption])"; 
  $Sup1=strtoupper($_POST[supplier1]);
  $Desc1=strtoupper($_POST[desc1]);
   mysql_query("UPDATE tour_agentreq set Supplier = '$Sup1',
                                        Description = '$Desc1', 
  ...
  mysql_query("UPDATE tour_agentreq set Supplier = '$Sup2',
                                        Description = '$Desc2',
  ...
  mysql_query("UPDATE tour_agentreq set Supplier = '$Sup3',
                                        Description = '$Desc3',
  ...
  mysql_query("UPDATE tour_agentreq set Supplier = '$Sup4',
                                        Description = '$Desc4',
  ...
  mysql_query("UPDATE tour_agentreq set Supplier = '$Sup5',
                                        Description = '$Desc5',
  ...
  mysql_query("UPDATE tour_agentreq set Supplier = '$Sup6',
                                        Description = '$Desc6',
  ...
  mysql_query("UPDATE tour_agentreq set Supplier = '$Sup7',
                                        Description = '$Desc7',
  ...
  mysql_query("UPDATE tour_agentreq set Supplier = '$Sup8',
                                        Description = '$Desc8',
  ...
  mysql_query("UPDATE tour_agentreq set Supplier = '$Sup9',
                                        Description = '$Desc9',
  ...
  mysql_query("UPDATE tour_agentreq set Supplier = '$Sup10',
                                        Description = '$Desc10',
  ...
  $alias=strtoupper($_POST[opta]);
  mysql_query("UPDATE tour_msdetailreq set TotalAdultA = '$_POST[totaladulta]',
...
$edit=mysql_query("SELECT * FROM tour_msproductreq WHERE IDProduct = '$_GET[id]'");
    ...
    $isitotal=mysql_query("SELECT * FROM tour_msdetailreq
                                where IDProduct = '$r[IDProduct]' ");
    $totfix=mysql_fetch_array($isitotal);
    if($totfix[AliasOptB]==''){$nameopt='OPTION B';}else{$nameopt=$totfix[AliasOptB];}
    $depdate = substr($r[DateTravelFrom],8,2);         
    echo "<form method=POST name='calculate' action='?module=agentreq&act=saveb'>
          <h2>OPTION NAME : <input type=text name='optb' value='$nameopt' size='80'> - TMR No : $datatmr[TmrNo].$datatmr[TmrOption]</h2>    
          <input type='hidden' name=id value='$r[IDProduct]'><input type='hidden' name='tourcode' value='$r[TourCode]'> 
          <input type='hidden' name='sellingoperator' value='$r[SellingOperator]'>
          <input type='hidden' name='sellingrate' value='$r[SellingRate]'>
          <input type='hidden' name='quotationcurr' value='$r[QuotationCurr]'>
          <input type='hidden' name='sellingcurr' value='$r[SellingCurr]'>";
            ...
            echo "<table>
                    <tr><th width=200>$datatmr[Seat] PAX<input type='hidden' name='paxb' size='3' value='$datatmr[Seat]'></th><th width=300></th><th colspan=2>adult</th><th colspan=4>Child </th></tr>
                    <tr><th></th><th></th><th colspan=2></th><th colspan=2>Twin BED</th><th colspan=2>Extra BED </th></tr>
                    <tr><th>supplier</th><th>description</th><th>In $r[QuotationCurr]</th><th>In $r[SellingCurr]</th><th>In $r[QuotationCurr]</th><th>In $r[SellingCurr]</th><th>In $r[QuotationCurr]</th><th>In $r[SellingCurr]</th></tr> 
                     ...
                     <td><input type=text name='quochdx1' size='12' value='$fix1[QuoChdXbedB]'onkeyup='isNumber(this);UpdateSellD(1)'></td><td><input type='text' name='sellchdx1' value='$fix1[SellChdXbedB]' size='12'onkeyup='isNumber(this);TotalD()' ></td></tr>
                     ...
                     <td><input type=text name='quochdx2' size='12' value='$fix2[QuoChdXbedB]'onkeyup='isNumber(this);UpdateSellD(2)'></td><td><input type='text' name='sellchdx2' value='$fix2[SellChdXbedB]' size='12'onkeyup='isNumber(this);TotalD()' ></td></tr>
                     ...
                     <td><input type=text name='quochdx3' size='12' value='$fix3[QuoChdXbedB]'onkeyup='isNumber(this);UpdateSellD(3)'></td><td><input type='text' name='sellchdx3' value='$fix3[SellChdXbedB]' size='12'onkeyup='isNumber(this);TotalD()' ></td></tr>
                     ...
                     <td><input type=text name='quochdx4' size='12' value='$fix4[QuoChdXbedB]'onkeyup='isNumber(this);UpdateSellD(4)'></td><td><input type='text' name='sellchdx4' value='$fix4[SellChdXbedB]' size='12'onkeyup='isNumber(this);TotalD()' ></td></tr>
                     ...
                     <td><input type=text name='quochdx5' size='12' value='$fix5[QuoChdXbedB]'onkeyup='isNumber(this);UpdateSellD(5)'></td><td><input type='text' name='sellchdx5' value='$fix5[SellChdXbedB]' size='12'onkeyup='isNumber(this);TotalD()' ></td></tr>
                     ...
                     <td><input type=text name='quochdx6' size='12' value='$fix6[QuoChdXbedB]'onkeyup='isNumber(this);UpdateSellD(6)'></td><td><input type='text' name='sellchdx6' value='$fix6[SellChdXbedB]' size='12'onkeyup='isNumber(this);TotalD()' ></td></tr>
                     ...
                     <td><input type=text name='quochdx7' size='12' value='$fix7[QuoChdXbedB]'onkeyup='isNumber(this);UpdateSellD(7)'></td><td><input type='text' name='sellchdx7' value='$fix7[SellChdXbedB]' size='12'onkeyup='isNumber(this);TotalD()' ></td></tr>
                     ...
                     <td><input type=text name='quochdx8' size='12' value='$fix8[QuoChdXbedB]'onkeyup='isNumber(this);UpdateSellD(8)'></td><td><input type='text' name='sellchdx8' value='$fix8[SellChdXbedB]' size='12'onkeyup='isNumber(this);TotalD()' ></td></tr>
                     ...
                     <td><input type=text name='quochdx9' size='12' value='$fix9[QuoChdXbedB]'onkeyup='isNumber(this);UpdateSellD(9)'></td><td><input type='text' name='sellchdx9' value='$fix9[SellChdXbedB]' size='12'onkeyup='isNumber(this);TotalD()' ></td></tr>
                     ...
                     <td><input type=text name='quochdx10' size='12' value='$fix10[QuoChdXbedB]'onkeyup='isNumber(this);UpdateSellD(10)'></td><td><input type='text' name='sellchdx10' value='$fix10[SellChdXbedB]' size='12'onkeyup='isNumber(this);TotalD()' ></td></tr>
                    ...
                    <td></td><td><input type='text' name='totalchdxbeda' value='$totfix[TotalChdXbedB]' size='12' style='text-align: left;font-weight:bold;border: 0px solid #000000;' readonly></td></tr>
                    </table>    
  ...
  $Sup1=strtoupper($_POST[supplier1]);
  $Desc1=strtoupper($_POST[desc1]);
  mysql_query("UPDATE tour_agentreq set QuoAdultB = '$_POST[quoadult1]',
  ...
  $Sup2=strtoupper($_POST[supplier2]);
  $Desc2=strtoupper($_POST[desc2]);
  mysql_query("UPDATE tour_agentreq set QuoAdultB = '$_POST[quoadult2]',
  ...
  $Sup3=strtoupper($_POST[supplier3]);
  $Desc3=strtoupper($_POST[desc3]);
  mysql_query("UPDATE tour_agentreq set QuoAdultB = '$_POST[quoadult3]',
  ...
  $Sup4=strtoupper($_POST[supplier4]);
  $Desc4=strtoupper($_POST[desc4]);
  mysql_query("UPDATE tour_agentreq set QuoAdultB = '$_POST[quoadult4]',
  ...
  $Sup5=strtoupper($_POST[supplier5]);
  $Desc5=strtoupper($_POST[desc5]);
  mysql_query("UPDATE tour_agentreq set QuoAdultB = '$_POST[quoadult5]',
  ...
  $Sup6=strtoupper($_POST[supplier6]);
  $Desc6=strtoupper($_POST[desc6]);
  mysql_query("UPDATE tour_agentreq set QuoAdultB = '$_POST[quoadult6]',
  ...
  $Sup7=strtoupper($_POST[supplier7]);
  $Desc7=strtoupper($_POST[desc7]);
  mysql_query("UPDATE tour_agentreq set QuoAdultB = '$_POST[quoadult7]',
  ...
  $Sup8=strtoupper($_POST[supplier8]);
  $Desc8=strtoupper($_POST[desc8]);
  mysql_query("UPDATE tour_agentreq set QuoAdultB = '$_POST[quoadult8]',
  ...
  $Sup9=strtoupper($_POST[supplier9]);
  $Desc9=strtoupper($_POST[desc9]);
  mysql_query("UPDATE tour_agentreq set QuoAdultB = '$_POST[quoadult9]',
  ...
  $Sup10=strtoupper($_POST[supplier10]);
  $Desc10=strtoupper($_POST[desc10]);
  mysql_query("UPDATE tour_agentreq set QuoAdultB = '$_POST[quoadult10]',
                                        ...
                                        SellingRateB = '$_POST[sellingrate]'
                                        WHERE Category = 'AGENT10' AND IDProduct = '$_POST[id]'");
  $aliasb=strtoupper($_POST[optb]);
  mysql_query("UPDATE tour_msdetailreq set TotalAdultB = '$_POST[totaladulta]',
...
$edit=mysql_query("SELECT * FROM tour_msproductreq WHERE IDProduct = '$_GET[id]'");
    ...
    $isitotal=mysql_query("SELECT * FROM tour_msdetailreq
                                where IDProduct = '$r[IDProduct]' ");
    $totfix=mysql_fetch_array($isitotal);   
    if($totfix[AliasOptC]==''){$nameopt='OPTION C';}else{$nameopt=$totfix[AliasOptC];}
    $depdate = substr($r[DateTravelFrom],8,2);         
    echo "<form method=POST name='calculate' action='?module=agentreq&act=savec'>
          <h2>OPTION NAME : <input type=text name='optc' value='$nameopt' size='80'> - TMR No : $datatmr[TmrNo].$datatmr[TmrOption]</h2> 
          <input type='hidden' name=id value='$r[IDProduct]'><input type='hidden' name='tourcode' value='$r[TourCode]'> 
          <input type='hidden' name='sellingoperator' value='$r[SellingOperator]'>
          <input type='hidden' name='sellingrate' value='$r[SellingRate]'>
          <input type='hidden' name='quotationcurr' value='$r[QuotationCurr]'>
          <input type='hidden' name='sellingcurr' value='$r[SellingCurr]'>";
            ...
            echo "<table>
                    <tr><th width=200>$datatmr[Seat] PAX<input type='hidden' name='paxc' size='3' value='$datatmr[Seat]'></th><th width=300></th><th colspan=2>adult</th><th colspan=4>Child </th></tr>
                    <tr><th></th><th></th><th colspan=2></th><th colspan=2>Twin BED</th><th colspan=2>Extra BED </th></tr>
                    <tr><th>supplier</th><th>description</th><th>In $r[QuotationCurr]</th><th>In $r[SellingCurr]</th><th>In $r[QuotationCurr]</th><th>In $r[SellingCurr]</th><th>In $r[QuotationCurr]</th><th>In $r[SellingCurr]</th></tr> 
                     ...
                     <td><input type=text name='quochdx1' size='12' value='$fix1[QuoChdXbedC]'onkeyup='isNumber(this);UpdateSellD(1)'></td><td><input type='text' name='sellchdx1' value='$fix1[SellChdXbedC]' size='12'onkeyup='isNumber(this);TotalD()' ></td></tr>
                     <tr><td>$fix2[Supplier]</td><td>$fix2[Description]</td>
                     ...
                     <td><input type=text name='quochdx2' size='12' value='$fix2[QuoChdXbedC]'onkeyup='isNumber(this);UpdateSellD(2)'></td><td><input type='text' name='sellchdx2' value='$fix2[SellChdXbedC]' size='12'onkeyup='isNumber(this);TotalD()' ></td></tr>
                     <tr><td>$fix3[Supplier]</td><td>$fix3[Description]</td>
                     ...
                     <td><input type=text name='quochdx3' size='12' value='$fix3[QuoChdXbedC]'onkeyup='isNumber(this);UpdateSellD(3)'></td><td><input type='text' name='sellchdx3' value='$fix3[SellChdXbedC]' size='12'onkeyup='isNumber(this);TotalD()' ></td></tr>
                     <tr><td>$fix4[Supplier]</td><td>$fix4[Description]</td>
                     ...
                     <td><input type=text name='quochdx4' size='12' value='$fix4[QuoChdXbedC]'onkeyup='isNumber(this);UpdateSellD(4)'></td><td><input type='text' name='sellchdx4' value='$fix4[SellChdXbedC]' size='12'onkeyup='isNumber(this);TotalD()' ></td></tr>
                     <tr><td>$fix5[Supplier]</td><td>$fix5[Description]</td>
                     ...
                     <td><input type=text name='quochdx5' size='12' value='$fix5[QuoChdXbedC]'onkeyup='isNumber(this);UpdateSellD(5)'></td><td><input type='text' name='sellchdx5' value='$fix5[SellChdXbedC]' size='12'onkeyup='isNumber(this);TotalD()' ></td></tr>
                     <tr><td>$fix6[Supplier]</td><td>$fix6[Description]</td>
                     ...
                     <td><input type=text name='quochdx6' size='12' value='$fix6[QuoChdXbedC]'onkeyup='isNumber(this);UpdateSellD(6)'></td><td><input type='text' name='sellchdx6' value='$fix6[SellChdXbedC]' size='12'onkeyup='isNumber(this);TotalD()' ></td></tr>
                     <tr><td>$fix7[Supplier]</td><td>$fix7[Description]</td>
                     ...
                     <td><input type=text name='quochdx7' size='12' value='$fix7[QuoChdXbedC]'onkeyup='isNumber(this);UpdateSellD(7)'></td><td><input type='text' name='sellchdx7' value='$fix7[SellChdXbedC]' size='12'onkeyup='isNumber(this);TotalD()' ></td></tr>
                     <tr><td>$fix8[Supplier]</td><td>$fix8[Description]</td>
                     ...
                     <td><input type=text name='quochdx8' size='12' value='$fix8[QuoChdXbedC]'onkeyup='isNumber(this);UpdateSellD(8)'></td><td><input type='text' name='sellchdx8' value='$fix8[SellChdXbedC]' size='12'onkeyup='isNumber(this);TotalD()' ></td></tr>
                     <tr><td>$fix9[Supplier]</td><td>$fix9[Description]</td>
                     ...
                     <td><input type=text name='quochdx9' size='12' value='$fix9[QuoChdXbedC]'onkeyup='isNumber(this);UpdateSellD(9)'></td><td><input type='text' name='sellchdx9' value='$fix9[SellChdXbedC]' size='12'onkeyup='isNumber(this);TotalD()' ></td></tr>
                     <tr><td>$fix10[Supplier]</td><td>$fix10[Description]</td>
                     ...
                     <td><input type=text name='quochdx10' size='12' value='$fix10[QuoChdXbedC]'onkeyup='isNumber(this);UpdateSellD(10)'></td><td><input type='text' name='sellchdx10' value='$fix10[SellChdXbedC]' size='12'onkeyup='isNumber(this);TotalD()' ></td></tr>
                    ...
                    <td></td><td><input type='text' name='totalchdxbeda' value='$totfix[TotalChdXbedC]' size='12' style='text-align: left;border: 0px solid #000000;' readonly></td></tr>
                    </table>    
  ...
  $Sup1=strtoupper($_POST[supplier1]);
  $Desc1=strtoupper($_POST[desc1]);
   mysql_query("UPDATE tour_agentreq set QuoAdultC = '$_POST[quoadult1]',
  ...
  $Sup2=strtoupper($_POST[supplier2]);
  $Desc2=strtoupper($_POST[desc2]);
  mysql_query("UPDATE tour_agentreq set QuoAdultC = '$_POST[quoadult2]',
  ...
  $Sup3=strtoupper($_POST[supplier3]);
  $Desc3=strtoupper($_POST[desc3]);
  mysql_query("UPDATE tour_agentreq set QuoAdultC = '$_POST[quoadult3]',
  ...
  $Sup4=strtoupper($_POST[supplier4]);
  $Desc4=strtoupper($_POST[desc4]);
  mysql_query("UPDATE tour_agentreq set QuoAdultC = '$_POST[quoadult4]',
  ...
  $Sup5=strtoupper($_POST[supplier5]);
  $Desc5=strtoupper($_POST[desc5]);
  mysql_query("UPDATE tour_agentreq set QuoAdultC = '$_POST[quoadult5]',
  ...
  $Sup6=strtoupper($_POST[supplier6]);
  $Desc6=strtoupper($_POST[desc6]);
  mysql_query("UPDATE tour_agentreq set QuoAdultC = '$_POST[quoadult6]',
  ...
  $Sup7=strtoupper($_POST[supplier7]);
  $Desc7=strtoupper($_POST[desc7]);
  mysql_query("UPDATE tour_agentreq set QuoAdultC = '$_POST[quoadult7]',
  ...
  $Sup8=strtoupper($_POST[supplier8]);
  $Desc8=strtoupper($_POST[desc8]);
  mysql_query("UPDATE tour_agentreq set QuoAdultC = '$_POST[quoadult8]',
  ...
  $Sup9=strtoupper($_POST[supplier9]);
  $Desc9=strtoupper($_POST[desc9]);
  mysql_query("UPDATE tour_agentreq set QuoAdultC = '$_POST[quoadult9]',
  ...
  $Sup10=strtoupper($_POST[supplier10]);
  $Desc10=strtoupper($_POST[desc10]);
  mysql_query("UPDATE tour_agentreq set QuoAdultC = '$_POST[quoadult10]',
                                        ...
                                        SellingRateC = '$_POST[sellingrate]' 
                                        WHERE Category = 'AGENT10' AND IDProduct = '$_POST[id]'");
  $aliasc=strtoupper($_POST[optc]);
  mysql_query("UPDATE tour_msdetailreq set TotalAdultC = '$_POST[totaladulta]',
